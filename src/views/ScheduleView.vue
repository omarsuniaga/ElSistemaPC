...
<template>
  <div class="schedule-view p-4 md:p-6 max-w-7xl mx-auto">
    ...
    <div v-else-if="error" class="bg-red-50 dark:bg-red-900/10 p-4 rounded-lg text-red-700 dark:text-red-400 mb-4">
      {{ error }}
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-6">
        <div class="flex flex-wrap items-center gap-4">
          <div class="w-full sm:w-auto">
            <label for="teacher-filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          <div class="w-full sm:w-auto">
            <label for="day-filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Filtrar por día
            </label>
            <select 
              id="day-filter"
          ...
          <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
              ...
              <div class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                <p>
                  <span class="font-medium">Profesor:</span> {{ schedule.teacherName }}
                </p>
                <p>
                  <span class="font-medium">Aula:</span> {{ schedule.room }}
                </p>
                <p>
                  <span class="font-medium">Estudiantes:</span> {{ schedule.studentCount }}
                </p>
              </div>
            </div>
