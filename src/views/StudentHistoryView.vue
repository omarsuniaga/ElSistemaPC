  ...
  <div class="student-history-view">
    ...
    <div class="filters mb-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="group-selector">
          ...
          <GroupSelector :value="selectedGroupId" @change="handleGroupChange" />
        </div>
    ...
    >
      ...
      <template #footer>
        ...
        <button class="px-4 py-2 bg-blue-600 text-white rounded" @click="showStudentModal = false">
    ...
    <BaseModal v-model="showAttendanceModal" title="Detalle de asistencia" size="md">
