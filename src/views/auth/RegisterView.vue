...
const handleRegister = async () => {
  ...
  try {
    ...
    successMessage.value = result.message || 'Registro exitoso. Tu cuenta está pendiente de aprobación.'
    setTimeout(() => {
        ...
        <div class="mt-4 flex justify-center">
          <ol class="flex items-center w-full">
            <li 
              ...
              :class="{ 'text-primary-600 dark:text-primary-400': currentStep >= 1, 'text-gray-400 dark:text-gray-600': currentStep < 1 }"
            >
              <span class="flex items-center justify-center w-8 h-8 rounded-full shrink-0 border transition-all"
                :class="currentStep >= 1 ? 'bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 border-primary-500' : 'bg-gray-100 dark:bg-gray-800 border-gray-300 dark:border-gray-700'"
              >
                1
              </span>
            </li>
            <li class="flex items-center"
              :class="{ 'text-primary-600 dark:text-primary-400': currentStep >= 2, 'text-gray-400 dark:text-gray-600': currentStep < 2 }"
            >
              <span class="flex items-center justify-center w-8 h-8 rounded-full shrink-0 border transition-all"
                :class="currentStep >= 2 ? 'bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 border-primary-500' : 'bg-gray-100 dark:bg-gray-800 border-gray-300 dark:border-gray-700'"
              >
                2
              </span>
            </li>
