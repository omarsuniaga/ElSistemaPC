...
<template>
  <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
      ...
      <!-- Error -->
      <div v-else-if="error" class="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 p-6 rounded-lg text-center">
      ...
      <div v-else-if="userStatus === 'pendiente'" class="text-center">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">
          Tu cuenta está siendo revisada por nuestros administradores. Este proceso puede tomar hasta 24 horas.
      ...
      <div v-else-if="userStatus === 'rechazado'" class="text-center">
        ...
        <div v-if="rejectionReason" class="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg text-left mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">
          Si consideras que esto es un error o deseas más información, por favor contacta con el soporte técnico.
        </p>
      ...
      <div v-else class="text-center">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">
          No podemos determinar el estado actual de tu cuenta. Por favor, intenta iniciar sesión nuevamente.
        </p>
        <button
          @click="handleLogout"
          class="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
