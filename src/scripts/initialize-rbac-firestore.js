...
const defaultPermissions = [
  ...
  { id: 'ver-estudiantes', name: 'Ver Estudiantes', description: 'Puede ver estudiantes de sus clases', module: 'students', action: 'read', resource: 'students' },
  { id: 'ver-todos-estudiantes', name: 'Ver Todos los Estudiantes', description: 'Puede ver todos los estudiantes de la academia', module: 'students', action: 'read', resource: 'all_students' },
