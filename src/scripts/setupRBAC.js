...
// Configuración de Firebase Admin - SOLO variables de entorno por seguridad
if (
  ...
  console.error('   Asegúrate de configurar en tu .env:');
...
async function assignPermissionsToRoles() {
  ...
  const rolePermissions = {
    ...
    admin: ['system_read', 'students_read', 'attendance_read', 'reports_read'],
  };
