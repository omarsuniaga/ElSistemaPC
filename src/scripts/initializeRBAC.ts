...
import {collection, doc, setDoc, getDocs, getDoc, query, writeBatch} from "firebase/firestore"
...
export class RBACInitializer {
  ...
  private async createBasePermissions(): Promise<void> {
    ...
    const permissions: Omit<Permission, "id">[] = [
      ...
      {
        name: "rbac_manage",
        description: "Gestionar sistema RBAC",
        module: "rbac",
        action: "manage",
        resource: "rbac",
      },
      {
        name: "rbac_view",
        description: "Ver configuración RBAC",
        module: "rbac",
        action: "view",
        resource: "rbac",
      },
      ...
      {
        name: "teachers_view_all",
        description: "Ver todos los maestros",
        module: "teachers",
        action: "view_all",
        resource: "teachers",
      },
      {
        name: "teachers_view_detail",
        description: "Ver detalle de maestro",
        module: "teachers",
        action: "view_detail",
        resource: "teachers",
      },
      ...
      {
        name: "students_view_detail",
        description: "Ver detalle de estudiante",
        module: "students",
        action: "view_detail",
        resource: "students",
      },
      ...
      {
        name: "classes_view_detail",
        description: "Ver detalle de clase",
        module: "classes",
        action: "view_detail",
        resource: "classes",
      },
      ...
      {
        name: "classes_teacher_view",
        description: "Ver clases como maestro",
        module: "classes",
        action: "teacher_view",
        resource: "classes",
      },
      ...
      },
      {
        ...
        description: "Editar asistencias",
        module: "attendance",
        action: "edit",
        resource: "attendance",
      },
      {
        name: "attendance_teacher_view",
        description: "Ver asistencias como maestro",
        module: "attendance",
        action: "teacher_view",
        resource: "attendance",
      },
      {
        ...
        description: "Ver calendario de asistencias",
        module: "attendance",
        action: "calendar",
        resource: "attendance",
      },
      ...
      {
        name: "schedule_teacher_view",
        description: "Ver horarios como maestro",
        module: "schedule",
        action: "teacher_view",
        resource: "schedule",
      },
      ...
      // Permisos de Instrumentos
      {
        ...
        description: "Ver instrumentos",
        module: "instruments",
        action: "view",
        resource: "instruments",
      },
      {
        name: "instruments_edit",
        description: "Editar instrumentos",
        module: "instruments",
        action: "edit",
        resource: "instruments",
      },
      {
        ...
        description: "Crear instrumentos",
        module: "instruments",
        action: "create",
        resource: "instruments",
      },
      ...
      // Permisos de Monitoreo
      {
        ...
        description: "Ver monitoreo diario",
        module: "monitoring",
        action: "view",
        resource: "monitoring",
      },
      ...
      // Permisos específicos de Dashboard de maestros
      {
        ...
        description: "Ver dashboard de maestro",
        module: "teacher",
