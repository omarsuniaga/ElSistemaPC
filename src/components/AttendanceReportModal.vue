<template>
  ...
  >
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-auto z-10">
      <div class="p-6">
          ...
          <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div class="bg-green-50 dark:bg-green-900 p-3 rounded shadow">
                ...
                <div class="text-xl font-bold">{{ stats.present }} ({{ stats.presentPercentage }}%)</div>
              </div>
              <div class="bg-red-50 dark:bg-red-900 p-3 rounded shadow">
                <div class="text-sm text-gray-500 dark:text-gray-300">Ausentes</div>
                <div class="text-xl font-bold">{{ stats.absent }} ({{ stats.absentPercentage }}%)</div>
              </div>
          ...
          <div>
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left">
                ...
                <tbody>
                  <tr v-for="(record, index) in displayedRecords" :key="index" class="border-b hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <div class="mt-4 flex justify-between items-center">
              <div class="text-sm text-gray-500">
                Mostrando {{ (currentPage - 1) * pageSize + 1 }} a {{ Math.min(currentPage * pageSize, filteredRecords.length) }} de {{ filteredRecords.length }}
              </div>
...
const filteredStudents = computed(() => {
  ...
  return students.value.filter(student => 
    isStudentInClass(student.id, filters.value.class)
  )
})
