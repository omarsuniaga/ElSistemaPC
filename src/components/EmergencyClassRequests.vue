<template>
  <div class="space-y-6">
    ...
    <!-- Error -->
    <div v-else-if="error" class="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg text-red-700 dark:text-red-400">
      {{ error }}
      <button @click="loadEmergencyClasses" class="text-sm underline ml-2">Reintentar</button>
    </div>
      ...
      >
        <div class="p-4">
          <div class="flex items-center justify-between flex-wrap gap-2 mb-2">
            ...
            <span class="badge bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300">
              Pendiente
            </span>
          </div>
