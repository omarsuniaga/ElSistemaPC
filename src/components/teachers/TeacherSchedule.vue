  ...
  <div class="teacher-schedule-container">
    ...
    <div v-if="viewMode === 'calendar'" class="calendar-view bg-white rounded-lg shadow-sm p-6">
      ...
      <div class="grid grid-cols-8 gap-1">
        ...
        <div v-for="day in weekDays" :key="day" class="text-xs font-medium text-gray-500 p-2 text-center">
          {{ day }}
        </div>
              ...
              <tr v-for="schedule in filteredSchedules" :key="schedule.id" class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      <div class="text-sm font-medium text-gray-900">{{ schedule.teacherName }}</div>
...
const filteredSchedules = computed(() => {
  return schedules.value.filter(schedule => {
    return (!selectedTeacher.value || schedule.teacherId === selectedTeacher.value) &&
...
const getStatusBadgeClass = (status: string) => {
  const classes = {
    ...
    'pausado': 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800',
    'completado': 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800'
  }
