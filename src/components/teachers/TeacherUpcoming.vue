  ...
  <div class="teacher-upcoming">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
      ...
      <div class="flex space-x-2">
        <button 
          ...
          class="btn"
          :class="dateRange === 'today' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600'"
        >
          Hoy
        </button>
        <button 
          ...
          class="btn"
          :class="dateRange === 'week' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600'"
        >
          Esta Semana
        </button>
        <button 
          ...
          class="btn"
          :class="dateRange === 'month' ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600'"
        >
          Este Mes
        </button>
      </div>
    ...
    <div class="mb-6">
      ...
      <div class="mb-8">
        ...
        <div class="timeline relative pl-8 before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-blue-200 dark:before:bg-blue-900/50">
          <div v-if="getTodayClasses().length === 0" class="py-4 text-gray-500 dark:text-gray-400 text-sm">
              ...
              <div class="p-4">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                  <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">{{ event.location }}</p>
      ...
      <template v-for="(group, index) in groupedUpcomingClasses" :key="index">
        <div class="mb-8">
          ...
          <div class="timeline relative pl-8 before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-200 dark:before:bg-gray-700">
            <div 
    ...
    <div v-if="upcomingEvents.length === 0 && !isLoading" class="text-center py-12">
      ...
      <p class="mt-1 text-gray-500">
        No tienes clases programadas para {{ getDateRangeText() }}.
      </p>
    </div>
...
const groupedUpcomingClasses = computed(() => {
  const todayEvents = upcomingEvents.value.filter(event => 
    isToday(event.startDateTime)
  );
  
  const futureEvents = upcomingEvents.value.filter(event => 
    !isToday(event.startDateTime)
  );
        ...
        cls.schedule.forEach(schedule => {
          ...
          while (currentCheckDate <= rangeEnd) {
            ...
            if (capitalizedWeekDay === schedule.day) {
              ...
              const hasSpecificEvent = events.some(event => 
