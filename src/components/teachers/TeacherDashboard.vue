...
const getActivityIcon = (type) => {
  switch (type) {
    ...
    case 'evaluation': return PencilSquareIcon;
    case 'class': return ClipboardDocumentListIcon;
...
const getActivityIconClass = (type) => {
  switch (type) {
    ...
    case 'class': return 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400';
