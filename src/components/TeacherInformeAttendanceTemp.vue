      ...
      <div v-else>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Asistencia por Fecha</h3>
            <div class="h-64">
              <canvas ref="chartDates"></canvas>
            </div>
          </div>
          
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Asistencia por Día de la Semana</h3>
            <div class="h-64">
        ...
        <div class="flex justify-between items-center mb-4">
          <div class="flex gap-2">
            ...
            <button 
              ...
              :class="viewMode === 'table' ? 'bg-primary-500 text-white' : 'bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300'"
              class="px-3 py-1 text-sm rounded"
            >
              Vista Tabla
            </button>
        ...
        <div id="printable-report" class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
          <div class="space-y-6">
            <!-- Informes por clase -->
            <div v-for="(classData, index) in classReports" :key="index" 
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    <component 
                      :is="expandedClasses.has(classData.classId) ? ChevronDownIcon : ChevronRightIcon" 
                      class="h-5 w-5 text-gray-500 mr-2" 
                    />
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">
                      {{ classData.className }}
                    </h3>
                    <span class="ml-3 px-2 py-1 text-xs bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 rounded">
              ...
              <div v-if="expandedClasses.has(classData.classId)" class="p-4 space-y-4">
                  ...
                  <div v-for="student in classData.students" :key="student.id" 
                    ...
                    <div class="flex items-center justify-between mb-3">
                      ...
                      <span class="text-sm text-gray-600 dark:text-gray-400">
                        {{ calculateStudentAttendancePercentage(student, classData.relevantDates) }}% asistencia
                      </span>
                    </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                      <tr>
                        ...
                        <th v-for="date in classData.relevantDates" :key="date"
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                      <tr v-for="student in classData.students" :key="student.id" 
                        ...
                        <td v-for="date in classData.relevantDates" :key="date" 
                ...
                <div v-if="classData.observations && classData.observations.length > 0" 
                  ...
                  <h5 class="font-medium text-yellow-800 dark:text-yellow-300 mb-2">Observaciones de la Clase</h5>
                  <div class="space-y-2">
                    <div v-for="obs in classData.observations" :key="obs.date" 
            ...
            <div v-if="classReports.length === 0" class="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <UserGroupIcon class="h-16 w-16 mx-auto text-gray-400 mb-4" />
