      ...
      <div class="px-6 py-4 flex justify-end space-x-3">
        <button 
          ...
          :class="{
            ...
            'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600': activeFilter !== key
          }"
        >
          {{ filter.label }}
        </button>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <thead class="bg-gray-50 dark:bg-gray-700">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Inasistencias</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Última clase</th>
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ student.absences }} inasistencias</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ student.lastClass }}</td>
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium text-gray-900 dark:text-white"></td>
            </tr>
          </tbody>
        </table>
      </div>
