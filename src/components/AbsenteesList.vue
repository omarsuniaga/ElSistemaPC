...
<template>
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      ...
      <div class="relative">
        ...
        <div
          ...
          class="absolute right-0 mt-1 w-64 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md shadow-lg z-50"
        >
          <div class="p-3 space-y-3">
            <div class="space-y-2">
              <label class="text-xs font-medium text-gray-700 dark:text-gray-300"
                >Seleccionar período</label
              >
              <div class="grid grid-cols-2 gap-2">
                <button
                  ...
                  @click="
                    () => {
                      selectedDateRange = key
                      key !== 'custom' && (showDateRangePicker = false)
                    }
                  "
                >
                  {{ label }}
    ...
    <div
      v-else-if="error"
      class="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 p-4 rounded-md flex items-center"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-5 w-5 mr-2"
      ...
      <span>{{ error }}</span>
      <button
        class="ml-auto text-blue-600 dark:text-blue-400 underline text-sm"
        @click="fetchAbsenceData"
      >
        Reintentar
      </button>
    </div>
    ...
    <div v-else>
      <div class="text-sm text-gray-600 dark:text-gray-400 mb-4">
        ...
        críticas, {{ groupCounts.concerning }} preocupantes, {{ groupCounts.moderate }} moderadas)
      </div>

      <!-- Critical Absences Group -->
      <div
        v-if="groupCounts.critical > 0"
        class="border border-red-200 dark:border-red-900 rounded-lg overflow-hidden mb-3"
      >
        <div
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <h4 class="font-medium text-red-800 dark:text-red-200">
              Ausencias Críticas ({{ groupCounts.critical }})
            </h4>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="relative">
                  ...
                  />
                  <span class="absolute -top-1 -right-1 h-4 w-4 rounded-full bg-red-600" />
                </div>
                <div>
                  <p class="font-medium">
      ...
      <div
        v-if="groupCounts.concerning > 0"
        class="border border-orange-200 dark:border-orange-900/50 rounded-lg overflow-hidden mb-3"
      >
        <div
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <h4 class="font-medium text-orange-800 dark:text-orange-200">
              Ausencias Preocupantes ({{ groupCounts.concerning }})
            </h4>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="relative">
                  ...
                  />
                  <span class="absolute -top-1 -right-1 h-4 w-4 rounded-full bg-orange-500" />
                </div>
                <div>
                  <p class="font-medium">
                    {{ getStudent(student.studentId)?.nombre }}
      ...
      <div
        v-if="groupCounts.moderate > 0"
        class="border border-yellow-200 dark:border-yellow-900/50 rounded-lg overflow-hidden"
      >
        <div
        ...
        >
          <div class="flex items-center gap-2">
            ...
            <h4 class="font-medium text-yellow-800 dark:text-yellow-200">
              Ausencias Moderadas ({{ groupCounts.moderate }})
            </h4>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="relative">
                  ...
                  />
                  <span class="absolute -top-1 -right-1 h-4 w-4 rounded-full bg-yellow-400" />
                </div>
                <div>
                  <p class="font-medium">
                    {{ getStudent(student.studentId)?.nombre }}
