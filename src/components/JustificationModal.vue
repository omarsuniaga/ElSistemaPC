<template>
  <transition name="modal-fade">
    ...
    >
      ...
      >
        <div
          class="border-b border-gray-200 dark:border-gray-700 p-4 flex justify-between items-center"
        >
        ...
        <div class="p-4">
          <p v-if="student && student.nombre" class="mb-3 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div
            v-if="selectedFile"
            class="mb-4 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-md flex items-center"
          >
            <svg
            ...
            <button class="ml-auto text-gray-400 hover:text-gray-500" @click="removeFile">
          ...
          <div v-if="isUploading" class="mb-4">
            <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
              <div class="h-full bg-indigo-600" :style="{width: uploadProgress + '%'}" />
            </div>
