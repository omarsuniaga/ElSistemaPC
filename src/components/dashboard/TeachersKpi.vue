...
<template>
  ...
  >
    ...
    >
      <div
        class="bg-white dark:bg-gray-800 rounded-lg max-w-lg w-full max-h-[80vh] overflow-y-auto"
      >
        <!-- Modal header -->
        <div
        ...
        <div class="p-4">
          ...
          <div v-if="selectedTeacher" class="flex flex-col items-center">
            <div class="h-24 w-24 rounded-full overflow-hidden mb-3">
              ...
              <div
                v-else
                class="h-full w-full bg-indigo-500 flex items-center justify-center text-white text-2xl font-bold"
              >
                {{ (selectedTeacher.nombre || "").charAt(0)
                }}{{ (selectedTeacher.apellido || "").charAt(0) }}
              </div>
            </div>
            ...
            <p
              v-if="selectedTeacher.instrument"
