  ...
  >
    ...
    <div class="mb-3">
      <div class="flex justify-between text-xs mb-1">
        ...
        <span class="font-bold" :class="`text-${completionColor}-600 dark:text-${completionColor}-400`">
          {{ classCompletionRate }}%
        </span>
      </div>
    ...
    <div>
      <div class="flex justify-between text-xs mb-1">
        ...
        <span class="font-bold" :class="`text-${classroomColor}-600 dark:text-${classroomColor}-400`">
