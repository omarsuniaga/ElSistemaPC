            ...
            <div class="flex items-start justify-between">
              <div class="flex-grow">
                <div class="flex items-center">
                  ...
                  />
                  <InformationCircleIcon v-else class="h-5 w-5 text-blue-500 mr-2" />
                ...
                <div v-if="result.details" class="mt-2">
                  <details class="text-xs">
                    ...
                    <pre class="mt-2 p-2 bg-gray-100 rounded text-gray-700 overflow-x-auto">{{
                      result.details
                    }}</pre>
                  </details>
                </div>
              </div>
              <div class="text-xs text-gray-500 ml-4">{{ result.duration }}ms</div>
            </div>
          </div>
        </div>
      </div>
