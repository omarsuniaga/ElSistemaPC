        ...
        <div class="bg-white px-6 py-4 max-h-96 overflow-y-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div class="bg-blue-50 p-4 rounded-lg">
                <div class="flex items-center">
                  ...
                  <div class="ml-3">
                    <p class="text-2xl font-semibold text-blue-900">{{ summary.attendanceRate }}%</p>
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
              ...
              <div class="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span class="ml-2 text-gray-900">{{ classData?.instrument || 'No especificado' }}</span>
                </div>
                <div>
                  <span class="font-medium text-gray-700">Nivel:</span>
                  <span class="ml-2 text-gray-900">{{ classData?.level || 'No especificado' }}</span>
                </div>
                <div>
                  <span class="font-medium text-gray-700">Horario:</span>
                  <span class="ml-2 text-gray-900">{{ classData?.schedule || 'No especificado' }}</span>
                </div>
                <div>
                  <span class="font-medium text-gray-700">Modalidad:</span>
                  <span class="ml-2 text-gray-900">{{ classData?.modality || 'No especificado' }}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div class="flex items-center space-x-4">
                  <div class="text-right">
                    <div class="text-sm text-gray-900">{{ student.stats.attendanceRate }}% asistencia</div>
                    <div class="text-xs text-gray-500">
                      {{ student.stats.present }}P / {{ student.stats.absent }}A / {{ student.stats.late }}T
                    </div>
                  </div>
          ...
          <div v-if="activeTab === 'calendar'" class="space-y-4">
            ...
            <div class="grid grid-cols-7 gap-1 text-xs">
              <!-- Headers de días -->
              <div v-for="day in ['Dom', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb']" :key="day" class="p-2 text-center font-medium text-gray-500">
                {{ day }}
              </div>
          ...
          <div v-if="activeTab === 'observations'" class="space-y-4">
            <div class="flex items-center justify-between">
              ...
              <span class="text-sm text-gray-500">{{ classObservations.length }} observaciones</span>
            </div>
...
const filteredStudents = computed(() => {
  ...
  let students = props.classData.students.filter(student => {
