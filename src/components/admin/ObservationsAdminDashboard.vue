        ...
        <div class="stat-card bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              ...
              <p class="text-2xl font-bold text-blue-900">{{ stats?.kpis?.totalObservations || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="stat-card bg-green-50 border border-green-200 rounded-lg p-4">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              ...
              <p class="text-2xl font-bold text-green-900">{{ stats?.kpis?.activeTeachers || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="stat-card bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              ...
              <p class="text-2xl font-bold text-purple-900">{{ stats?.kpis?.activeClasses || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="stat-card bg-orange-50 border border-orange-200 rounded-lg p-4">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              ...
              <p class="text-2xl font-bold text-orange-900">{{ stats?.kpis?.criticalObservations || 0 }}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div v-for="(count, month) in stats.monthlyTrends" :key="month" class="flex items-center">
            ...
            <div class="flex-1 bg-gray-200 rounded-full h-2 ml-3">
              <div 
                ...
                :style="{ width: `${(count / Math.max(...Object.values(stats.monthlyTrends))) * 100}%` }"
              ></div>
            </div>
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <div class="ml-3 flex-1">
              ...
              <p class="text-xs text-gray-500">{{ data.total }} observaciones • {{ data.classCount }} clases</p>
            </div>
            <div class="text-right">
              <div class="text-sm font-medium text-gray-900">{{ Math.round(data.followUpRate) }}%</div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="observation in paginatedObservations" :key="observation.id" class="hover:bg-gray-50">
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                {{ formatDate(observation.date) }}
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm font-medium text-gray-900">{{ observation.authorName || observation.author }}</div>
                <div class="text-sm text-gray-500">{{ observation.authorId.substring(0, 8) }}...</div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
