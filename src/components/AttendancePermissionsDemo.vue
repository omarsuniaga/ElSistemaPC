...
<template>
  <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-1">
            Rol actual: {{ userRole }} | 
            Alcance: {{ hasGlobalScope ? 'Global' : 'Clase asignada' }}
          </p>
        </div>
    ...
    <div v-if="isDevelopment" class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
      <h4 class="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Debug - Información de Permisos</h4>
      <div class="text-sm text-yellow-700 dark:text-yellow-300 space-y-1">
        ...
        <p><strong>Puede ver info confidencial:</strong> {{ canViewConfidentialInfo ? 'Sí' : 'No' }}</p>
