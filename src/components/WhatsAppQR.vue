  ...
  <div class="whatsapp-qr-container">
    ...
    <div class="status-container">
      ...
      >
        ...
        <div v-if="connectionStatus === 'reconnecting'" class="loader ml-2"></div>
      </div>
    </div>
    ...
    <div class="qr-container">
      ...
      <div v-else-if="connectionStatus === 'connected'" class="qr-connected">
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Ya puedes enviar notificaciones por WhatsApp
        </p>
      </div>
    ...
    <div class="instructions">
      ...
      <ol class="instructions-list">
        ...
        <li><strong>IMPORTANTE:</strong> Después del escaneo, tu teléfono mostrará "Vinculando dispositivo..."</li>
...
const testDirectConnection = async () => {
  ...
  try {
    ...
    alert("❌ Error al probar conexión: " + (error instanceof Error ? error.message : "Error desconocido"))
  } finally {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/send-message`, {
      ...
      body: JSON.stringify({
        ...
        message: '🎵 Mensaje de prueba desde la Academia Musical! WhatsApp está funcionando correctamente.'
      })
    })
