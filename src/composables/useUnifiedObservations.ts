...
export async function fetchUnifiedObservationsForClass(classId: string) {
  try {
    ...
    console.log(`[UnifiedObservations] Found ${observations.length} observations for class ${classId}`);
    return observations;
...
export async function fetchUnifiedObservationsForTeacher(teacherId: string) {
  try {
    ...
    console.log(`[UnifiedObservations] Found ${observations.length} observations for teacher ${teacherId}`);
    return observations;
