...
export function useBranding() {
  ...
  const appDescription = computed(() => config.appDescription || 'Sistema de gestión de academia musical')
  ...
  const welcomeMessage = computed(() => 
    advancedConfig.value.welcomeMessage || 
    `Bienvenido a ${appTitle.value}`
  )
