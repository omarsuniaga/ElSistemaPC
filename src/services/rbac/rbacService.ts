...
class RBACService {
  ...
  async checkUserPermission(userId: string, permission: string): Promise<boolean> {
    ...
    const moduleConfig = this.baseModules.find(m => m.moduleName.toLowerCase() === moduleId.toLowerCase());
    ...
    console.log(`🔐 RBAC: Module access check - User roles: ${userRoles}, Module allowed roles: ${moduleConfig.allowedRoles}, Has access: ${hasRoleAccess}`);
    ...
    for (const moduleConfig of this.baseModules) {
      console.log(`🔎 RBAC: Checking module ${moduleConfig.moduleName} with ${moduleConfig.routes.length} routes`);
      ...
      if (route) {
        ...
        if (route.isAccessible) {
          ...
          console.log(`🔑 RBAC: Role access check - User roles: ${userRoles}, Route allowed roles: ${route.allowedRoles}, Has access: ${hasRoleAccess}`);
