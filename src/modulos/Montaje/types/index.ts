...
export const INSTRUMENT_FAMILIES = {
  STRINGS: [TipoInstrumento.VIOLIN1, TipoInstrumento.VIOLIN2, TipoInstrumento.VIOLA, TipoInstrumento.CELLO, TipoInstrumento.CONTRABAJO],
  WOODWINDS: [TipoInstrumento.FLUTE, TipoInstrumento.OBOE, TipoInstrumento.CLARINET, TipoInstrumento.BASSOON],
  BRASS: [TipoInstrumento.HORN, TipoInstrumento.TRUMPET, TipoInstrumento.TROMBONE, TipoInstrumento.TUBA],
  PERCUSSION: [TipoInstrumento.TIMPANI, TipoInstrumento.PERCUSSION, TipoInstrumento.MARIMBA, TipoInstrumento.XYLOPHONE],
...
export const EVALUATION_WEIGHTS = {
  ...
  [CriterioEvaluacion.DINAMICA]: 0.10,
  [CriterioEvaluacion.EXPRESION]: 0.15,
  [CriterioEvaluacion.TECNICA_INSTRUMENTAL]: 0.20,
