    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
          ...
          <select v-model="filters.period" class="w-full px-3 py-2 border border-gray-300 rounded-md">
        ...
        <div>
          ...
          <select v-model="filters.entityType" class="w-full px-3 py-2 border border-gray-300 rounded-md">
        ...
        <div>
          ...
          <select v-model="filters.instructor" class="w-full px-3 py-2 border border-gray-300 rounded-md">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-center space-x-3">
              <span class="w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-sm font-medium">
                {{ index + 1 }}
              </span>
              <div>
        ...
        >
          <div class="flex-shrink-0">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path v-if="alert.type === 'warning'" fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
              <path v-else-if="alert.type === 'info'" fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
...
const topInstructors = ref([
  { id: '1', nombre: 'María González', obrasAsignadas: 8, progresoPromedio: 85, evaluacionPromedio: 8.5 },
  { id: '2', nombre: 'Carlos Pérez', obrasAsignadas: 6, progresoPromedio: 78, evaluacionPromedio: 8.2 },
  { id: '3', nombre: 'Ana Rodríguez', obrasAsignadas: 7, progresoPromedio: 82, evaluacionPromedio: 8.7 }
])
