...
describe('useMontaje Composable', () => {
  ...
  describe('crearObra', () => {
    ...
    it('debe validar rango de dificultad', async () => {
      ...
      await expect(crearObra(obraConDificultadInvalida)).rejects.toThrow('Nivel de dificultad debe estar entre 1 y 5')
    })
  })
  ...
  describe('generarReporteObra', () => {
    ...
    it('debe generar reporte con datos completos', async () => {
      ...
      expect(reporte).toEqual(expect.objectContaining({
