  ...
  <div class="space-y-4">
    ...
    <div v-if="filteredNotifications.length === 0" class="text-center py-8">
      <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5-5-5h5V6a1 1 0 112 0v11z"></path>
      </svg>
      <h3 class="mt-2 text-sm font-medium text-gray-900">No hay notificaciones</h3>
      <p class="mt-1 text-sm text-gray-500">
        {{ currentFilter === 'all' ? 'No tienes notificaciones' : 'No hay notificaciones en esta categoría' }}
      </p>
    </div>
      ...
      >
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1 min-w-0">
            ...
            <!-- Related Entity Info -->
            <div v-if="notification.entidadRelacionada" class="mt-2 flex items-center text-xs text-gray-500">
              <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h4a1 1 0 011 1v1a1 1 0 01-1 1v9a1 1 0 01-1 1H4a1 1 0 01-1-1V7a1 1 0 01-1-1V5a1 1 0 011-1h4z"></path>
              </svg>
              {{ getEntityTypeLabel(notification.entidadRelacionada.tipo) }}: {{ notification.entidadRelacionada.nombre }}
            </div>
