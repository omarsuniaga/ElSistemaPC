        ...
        <div class="flex justify-between mb-2">
          <div class="flex items-center">
            <input 
              ...
              :indeterminate.prop="alumnosSeleccionados.length > 0 && alumnosSeleccionados.length < alumnosDisponibles.length"
...
const selectionSummary = computed(() => {
  ...
  if (count === 1) {
    ...
    const instrumentoText = compas.instrumento 
      ? ` (${compas.instrumento})` 
      : '';
  ...
  if (Object.keys(porInstrumento).length === 1) {
    ...
    const texto = instrumento !== 'sin_instrumento'
