    ...
    <div class="relative p-8 border w-full max-w-2xl shadow-lg rounded-md bg-white">
      ...
      <form class="space-y-4" @submit.prevent="handleSubmit">
        <div>
          ...
          <input
id="projectName" v-model="form.name" type="text" required
        ...
        <div>
          ...
          <textarea
id="projectDescription" v-model="form.description" rows="3"
        ...
        <div>
          ...
          <input
id="director" v-model="form.director" type="text" required
                 class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
        </div>
        ...
        <div>
          ...
          <input
id="organization" v-model="form.organization" type="text" required
                 class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
        </div>
        ...
        <div>
          ...
          <input
id="season" v-model="form.season" type="text"
                 class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
id="startDate" v-model="form.startDate" type="date" required
                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
          </div>
          <div>
            <label for="endDate" class="block text-sm font-medium text-gray-700">Fecha de Fin</label>
            <input
id="endDate" v-model="form.endDate" type="date" required
                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
          </div>
        </div>
        ...
        <div class="flex justify-end space-x-3 mt-6">
          <button
type="button" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                  @click="$emit('close')">
            Cancelar
          </button>
          <button
