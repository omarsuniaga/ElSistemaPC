      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="flex items-center mb-4">
            ...
            <div class="flex-1 h-px bg-gray-200 ml-4" />
          </div>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div v-if="event.cambios && Object.keys(event.cambios).length > 0" class="mt-3">
                  ...
                  <div
                    v-if="expandedChanges.includes(event.id)"
                    class="mt-2 bg-gray-50 rounded-md p-3"
                  >
                    <div class="space-y-2">
                      <div v-for="(change, field) in event.cambios" :key="field" class="text-xs">
