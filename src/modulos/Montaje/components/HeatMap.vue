  ...
  <div class="heat-map">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-2">
          ...
          <div class="flex items-center space-x-1">
            <span class="inline-block w-4 h-4 rounded bg-pink-300"></span>
            <span class="text-xs text-gray-600">Sin trabajar</span>
          </div>
          <div class="flex items-center space-x-1">
            <span class="inline-block w-4 h-4 rounded bg-orange-300"></span>
            <span class="text-xs text-gray-600">Leído</span>
          </div>
          <div class="flex items-center space-x-1">
            <span class="inline-block w-4 h-4 rounded bg-yellow-300"></span>
    ...
    <div class="mb-4">
      <div class="flex justify-between items-center mb-2">
        ...
        <span class="text-sm text-gray-500">{{ completedMeasures }}/{{ totalMeasures }} compases</span>
      </div>
      ...
      <template v-else>
        ...
        <div class="grid grid-cols-10 gap-2">
          ...
          >
            ...
            <span v-if="measure.teacherInitial" 
            ...
            <div v-if="measure.observacion" class="relative group">
              ...
              <div class="hidden group-hover:block absolute bottom-full left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2 z-10 w-32">
                {{ measure.observacion }}
              </div>
            </div>
          </div>
    ...
    <div v-if="showObservationModal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-lg p-6 w-96 max-w-full">
        <h4 class="text-lg font-semibold mb-4">Observación para Compás {{ selectedMeasure?.numero }}</h4>
        <textarea 
...
const completedMeasures = computed(() => measures.value.filter(m => m.estado === 'logrado').length);
...
watch(() => props.initialMeasures, (newMeasures) => {
