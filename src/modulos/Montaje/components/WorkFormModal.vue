<template>
  ...
  >
    <div
      class="modal-container bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden"
    >
      <!-- Header -->
      ...
      <div class="modal-content overflow-y-auto max-h-[calc(90vh-120px)]">
        <form class="p-6 space-y-6" @submit.prevent="handleSubmit">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- Audio URL -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2"> URL del audio </label>
              <input
