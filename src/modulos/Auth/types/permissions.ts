...
export const DIRECTOR_PERMISSIONS: Permission[] = [
  ...
  // ========== SUPERVISIÓN ==========
  { resource: ResourceType.SUPERVISE_MAESTRO_ATTENDANCE, action: PermissionAction.SUPERVISE, scope: 'all' },
  { resource: ResourceType.SUPERVISE_MAESTRO_OBSERVATIONS, action: PermissionAction.SUPERVISE, scope: 'all' },
  { resource: ResourceType.SUPERVISE_MONTAJE, action: PermissionAction.SUPERVISE, scope: 'all' },
  { resource: ResourceType.SUPERVISE_STUDENT_EVALUATIONS, action: PermissionAction.SUPERVISE, scope: 'all' },
  
  // ========== REPORTES ==========
  { resource: ResourceType.ATTENDANCE_REPORTS, action: PermissionAction.GENERATE_REPORTS, scope: 'all' },
  ...
  { resource: ResourceType.ALL_TEACHERS, action: PermissionAction.DELETE, scope: 'all' },  { resource: ResourceType.ALL_TEACHERS, action: PermissionAction.READ, scope: 'all' }
];
...
export function isValidPermission(permission: Permission): boolean {
  return Object.values(ResourceType).includes(permission.resource) &&
...
export function hasPermission(userRole: UserRole, resource: ResourceType, action: PermissionAction, scope?: string): boolean {
...
export const MODULE_PERMISSIONS = {
  ...
  EVALUATIONS: [
    ResourceType.STUDENT_EVALUATIONS
  ],
  REPORTS: [
