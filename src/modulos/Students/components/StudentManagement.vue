<template>
  <div class="space-y-4">
    <!-- Cabecera del grupo -->
    <div
      class="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 p-3 rounded-lg mb-4"
    >
    ...
    <div
      v-else
      class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-sm"
    >
      <div
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center text-blue-800 dark:text-blue-200"
          >
        ...
        <PermissionGuard :required-resource="ResourceType.ALL_STUDENTS" required-action="delete">
          <button
