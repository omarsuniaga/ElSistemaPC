<template>
  <div class="space-y-4">
    ...
    <div
      class="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 p-3 rounded-lg mb-2 text-sm"
    >
    ...
    <div class="flex flex-col relative">
      ...
      <ul
        v-if="searchQuery"
        class="absolute z-10 mt-12 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg max-h-48 overflow-y-auto"
      >
        <li
