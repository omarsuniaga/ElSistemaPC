      ...
      <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        ...
        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <!-- Student avatar/icon -->
            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 dark:bg-blue-900 sm:mx-0 sm:h-12 sm:w-12">
              <svg class="h-8 w-8 text-blue-600 dark:text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              ...
              <div class="mt-4 space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div v-if="student.instrument" class="bg-gray-50 dark:bg-gray-700 p-3 rounded-md">
                    <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Instrumento</h4>
                    <p class="text-base text-gray-900 dark:text-gray-100">{{ student.instrument }}</p>
                  </div>
                  ...
                  <div v-if="student.address" class="bg-gray-50 dark:bg-gray-700 p-3 rounded-md sm:col-span-2">
