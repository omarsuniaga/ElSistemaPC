  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <p class="text-lg font-semibold text-blue-600 dark:text-blue-400">{{ stats.activeClasses }}</p>
      ...
      <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <p class="text-lg font-semibold text-purple-600 dark:text-purple-400">{{ stats.efficiency }}%</p>
    ...
    <div class="mb-6">
      <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
        ...
        <div
          ...
          :class="{
            'bg-red-50 dark:bg-red-900/20 border-red-400 dark:border-red-600': alert.type === 'error',
            'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-400 dark:border-yellow-600': alert.type === 'warning',
            'bg-blue-50 dark:bg-blue-900/20 border-blue-400 dark:border-blue-600': alert.type === 'info',
            'bg-green-50 dark:bg-green-900/20 border-green-400 dark:border-green-600': alert.type === 'success'
          }"
        >
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <div class="mt-2 flex space-x-2" v-if="alert.actions">
                <button 
    ...
    <div class="mb-6">
      <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
        ...
        Actividades de Hoy
      </h4>      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center">
              ...
              <div class="ml-3">
                <h5 class="font-medium text-blue-900 dark:text-blue-100">Registros de Asistencia</h5>
                <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ activitySummary.attendanceRecords }}</p>
              </div>
            </div>
          </div>
          <div class="space-y-1">
          ...
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center">
              ...
              <div class="ml-3">
                ...
                <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ activitySummary.newStudents }}</p>
              </div>
            </div>
          </div>
          <div class="space-y-1">
          ...
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center">
              ...
              <div class="ml-3">
                ...
                <p class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ activitySummary.observations }}</p>
              </div>
            </div>
          </div>
          <div class="space-y-1">
    ...
    <div>
      <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
        ...
        Próximas Actividades
      </h4>      <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
        <div class="space-y-3">
          <div
          ...
          <div v-if="upcomingActivities.length === 0" class="text-center py-4 text-gray-500 dark:text-gray-400">
