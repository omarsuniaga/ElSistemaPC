<template>
  <div class="pending-approvals-list">
    ...
    <!-- Empty State -->
    <div v-else-if="!approvals || approvals.length === 0" class="flex flex-col items-center justify-center py-8 text-center">
    ...
    <div v-else class="space-y-0">
      ...
      >
        <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200 rounded-lg">
          <!-- Approval Header -->
          <div class="flex items-start justify-between mb-3">
            <div class="flex items-start space-x-3 flex-1">
              <!-- Priority Indicator -->
              <div class="flex-shrink-0 mt-1">
                <div class="w-3 h-3 rounded-full" :class="getPriorityColor(approval.priority)"></div>
              </div>
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium" :class="getTypeClasses(approval.type)">
          ...
          <div v-if="approval.data && showPreview" class="mb-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div class="text-xs text-gray-600 dark:text-gray-400">
              <div v-for="(value, key) in getPreviewData(approval.data)" :key="key" class="flex justify-between py-1">
          ...
          <!-- Processing Overlay -->
          <div v-if="processing === approval.id" class="absolute inset-0 bg-white dark:bg-gray-800 bg-opacity-80 flex items-center justify-center rounded-lg">
...
interface PendingApproval {
  id: string
  type: 'teacher_registration' | 'schedule_change' | 'class_creation' | 'student_enrollment' | 'resource_request'
  title: string
  description: string
  requestedBy: string
  requestedAt: Date
