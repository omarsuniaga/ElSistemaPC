  ...
  >
    ...
    >
      ...
      <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Detalles de Actividad</h3>
        <button
      ...
      <div class="space-y-4">
            ...
            <div class="flex-1">
              ...
              <div class="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span
                    class="ml-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium capitalize"
        ...
        <div v-if="activity.priority" class="flex items-center space-x-2">
          ...
          <span
            ...
            :class="getPriorityClasses(activity.priority)"
          >
        ...
        <div v-if="relatedActivities && relatedActivities.length > 0" class="space-y-2">
          ...
          <div class="space-y-2">
            ...
            >
              <div class="w-2 h-2 rounded-full" :class="getActivityIconColor(related)" />
              <div class="flex-1">
                <p class="text-sm text-gray-900 dark:text-white">{{ related.description }}</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                  {{ formatTimeAgo(related.timestamp) }}
                </p>
              </div>
            </div>
          </div>
