  ...
  <div class="relative">
    ...
    >
      <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7v6a2 2 0 002 2h2"/>
      ...
      <span v-if="notificationCount > 0" class="ml-1 px-2 py-1 text-xs bg-red-500 text-white rounded-full">
        {{ notificationCount }}
      </span>
    </button>
