    ...
    >
      <div class="mt-3">
        ...
        <div class="flex items-center justify-between pb-4 border-b">
          <div>
            <h3 class="text-lg font-medium text-gray-900">Asignar Clases</h3>
            <p class="text-sm text-gray-600 mt-1">{{ teacher.nombre }} {{ teacher.apellido }}</p>
          </div>
        ...
        <div class="mt-6">
          ...
          <div class="mb-6">
            <div class="flex flex-col sm:flex-row gap-4">
              <div class="flex-1">
                <label class="block text-sm font-medium text-gray-700 mb-1"> Buscar clases </label>
                <input
                  v-model="searchQuery"
                  type="text"
