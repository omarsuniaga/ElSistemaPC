<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div
      class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-7xl w-full mx-4 max-h-[95vh] overflow-y-auto"
    >
      ...
      <div v-if="error" class="p-6">
        <div
          class="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 p-4 rounded-lg flex items-center"
        >
          <ExclamationTriangleIcon class="w-5 h-5 mr-2" />
          {{ error }}
          <button
            class="ml-auto bg-red-600 text-white px-3 py-1 rounded text-sm hover:bg-red-700 transition-colors"
      ...
      <div v-else class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div
            class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow"
          >
            <div class="flex items-center justify-between">
              <div>
                ...
                <div class="text-xs opacity-75 mt-1">
                  {{ studentsStore.studentStats.total }} estudiantes +
                  {{ teachersStore.teachers.length }} maestros
                </div>
              </div>
          ...
          <div
            class="bg-gradient-to-r from-green-500 to-green-600 text-white p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow"
          >
            <div class="flex items-center justify-between">
              <div>
          ...
          <div
            class="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow"
          >
            <div class="flex items-center justify-between">
              <div>
                <div class="text-3xl font-bold">{{ systemStats.dailyAttendance }}%</div>
                <div class="text-sm opacity-90">Asistencia Semanal</div>
                <div class="text-xs opacity-75 mt-1">Últimos 7 días</div>
              </div>
          ...
          <div
            class="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow"
          >
            <div class="flex items-center justify-between">
              <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5 shadow-sm">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
              ...
              <span
                class="ml-2 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs px-2 py-1 rounded-full"
              >
            ...
            <div class="space-y-3 max-h-64 overflow-y-auto custom-scrollbar">
              ...
              >
                <div class="w-2 h-2 bg-green-500 rounded-full animate-pulse mt-2 flex-shrink-0" />
          ...
          <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5 shadow-sm">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
              ...
              Alertas del Sistema
              <span
                class="ml-2 bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 text-xs px-2 py-1 rounded-full"
              >
                {{ systemAlerts.length }}
              </span>
            </h3>
            <div class="space-y-3 max-h-64 overflow-y-auto custom-scrollbar">
              <div
                ...
                :class="{
                  'border border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900/30':
                    alert.severity === 'critical',
                  'border border-orange-300 dark:border-orange-700 bg-orange-50 dark:bg-orange-900/30':
                    alert.severity === 'high',
                  'border border-yellow-300 dark:border-yellow-700 bg-yellow-50 dark:bg-yellow-900/30':
                    alert.severity === 'medium',
                  'border border-blue-300 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/30':
                    alert.severity === 'low',
                }"
              >
              ...
              >
                <div
                  class="w-8 h-8 mx-auto mb-2 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="space-y-3 text-sm">
              <div
                class="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-600 rounded"
              >
              ...
              >
                ...
                <span class="font-semibold text-gray-900 dark:text-white">{{
                  module.operations.toLocaleString()
                }}</span>
              </div>
              <div
                class="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-600 rounded"
                ...
                <span
                  ...
                  :class="{
                    ...
                    'text-yellow-600 dark:text-yellow-400':
                      module.responseTime >= 100 && module.responseTime < 200,
