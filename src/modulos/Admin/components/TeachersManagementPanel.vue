  ...
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div v-if="showFilters" class="bg-gray-50 p-4 rounded-lg mb-6">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <select v-model="filters.specialty" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">
        ...
        <div>
          ...
          <select v-model="filters.experience" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">
    ...
    <div class="flex items-center justify-between mt-6">
      <div class="text-sm text-gray-700">
        Mostrando {{ (currentPage - 1) * itemsPerPage + 1 }} a {{ Math.min(currentPage * itemsPerPage, totalTeachers) }} de {{ totalTeachers }} maestros
      </div>
      <div class="flex space-x-2">
        <button
          @click="currentPage--"
