      ...
      <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
          <div class="flex items-center space-x-3">
            ...
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" v-html="getActionIcon(actionType)"/>
            </div>
            <div>
              <h3 class="text-lg font-semibold text-gray-900">{{ getActionTitle(actionType) }}</h3>
              <p class="text-sm text-gray-500">{{ selectedItems.length }} elemento(s) seleccionado(s)</p>
            </div>
          </div>
          <button
            @click="closeModal"
...
const getActionIcon = (type: string) => {
  const icons = {
    ...
    assign: '<path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/>',
    notify: '<path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/>',
