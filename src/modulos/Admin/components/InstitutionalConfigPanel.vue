  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
    ...
    <div v-else class="space-y-6">
      ...
      <div>
        ...
        <div v-if="institutionalLogoUrl" class="mb-4 p-4 border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700">
        ...
        >
          ...
          <div v-else class="space-y-2">
            <div class="w-8 h-8 mx-auto border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
      ...
      <!-- Preview Section -->
      <div v-if="institutionalTitle || institutionalLogoUrl" class="border-t border-gray-200 dark:border-gray-700 pt-6">
...
const resetToDefaults = async () => {
  if (confirm('¿Estás seguro de que quieres restaurar la configuración por defecto? Esto eliminará el logo actual.')) {
    try {
