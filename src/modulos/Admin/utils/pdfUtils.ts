...
export const generatePDFHeader = (reportType: string, context: HeaderContext = {}): PDFHeaderInfo => {
...
export const addPDFHeader = (doc: jsPDF, headerInfo: PDFHeaderInfo, startY: number = 20): number => {
  let currentY = startY
