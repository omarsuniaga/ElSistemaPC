        ...
        <div v-else class="bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <div class="p-6">
                ...
                <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
                  ...
                  <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <tr v-for="role in roles" :key="role.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td class="px-6 py-4">
                        <div class="text-sm text-gray-500 dark:text-gray-300">{{ role.description }}</div>
                      </td>
                      <td class="px-6 py-4">
            ...
            <div v-if="activeTab === 'permissions'">
              <div class="flex justify-between items-center mb-6">
                <h2 class="text-lg font-medium text-gray-900 dark:text-white">Permisos del Sistema</h2>
                <button
              ...
              <div class="space-y-6">
                <div v-for="(modulePermissions, module) in permissionsByModule" :key="module" class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    >
                      <div class="flex justify-between items-start mb-2">
                        <h4 class="text-sm font-medium text-gray-900 dark:text-white">{{ permission.name }}</h4>
                        <button
                      ...
                      <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">{{ permission.description }}</p>
        ...
        <div class="mt-3">
          ...
          <form @submit.prevent="saveRole" class="space-y-4">
            ...
            <div>
              ...
              <div class="max-h-60 overflow-y-auto border border-gray-300 dark:border-gray-600 rounded-md p-3">
        ...
        <div class="mt-3">
          ...
          <form @submit.prevent="savePermission" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Módulo</label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Acción</label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Recurso</label>
                <input
