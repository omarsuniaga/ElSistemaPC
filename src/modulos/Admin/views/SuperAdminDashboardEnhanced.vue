<template>
  ...
  >
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <ActionButton
                  ...
                  @click="$router.push('/admin/teachers/advanced')"
                />
                <ActionButton :icon="ClockIcon" title="Horarios" color="blue" @click="() => {}" />
                <ActionButton
                  :icon="CurrencyDollarIcon"
                  title="Nómina"
                  color="green"
    ...
    <!-- Alerts Modal -->
    <Modal :show="showAlertsModal" title="Alertas Críticas" @close="showAlertsModal = false">
      <div class="p-6">
