<template>
  <div class="p-4 max-w-5xl mx-auto">
    ...
    >
      {{ error }}
      <button class="ml-2 underline" @click="loadProfile">Reintentar</button>
    </div>
    ...
    <div v-else-if="profileStore.profile" class="space-y-6">
      ...
      <section class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        <div
          class="flex items-center gap-2 bg-primary-50 dark:bg-primary-900/30 p-3 border-b border-primary-200 dark:border-primary-800"
        >
          <UserIcon class="h-5 w-5 text-primary-700 dark:text-primary-400" />
          <h2 class="text-lg font-bold text-primary-700 dark:text-primary-400">
        ...
        <div class="p-4">
          <div class="flex flex-col md:flex-row gap-6 items-center md:items-start">
            ...
            <div class="relative group">
              ...
              />
              <button
                class="absolute bottom-0 right-0 bg-white dark:bg-gray-800 p-2 rounded-full shadow-md group-hover:opacity-100 opacity-0 transition-opacity"
              >
            ...
            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p class="font-medium">
                  {{ profileStore.profile.displayName || "No especificado" }}
                </p>
              </div>
              ...
              <div>
                ...
                <p class="font-medium capitalize">
                  {{ profileStore.profile.role || "No especificado" }}
                </p>
              </div>
      ...
      <section class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        ...
        <div class="p-4">
          ...
          <div v-else class="text-center py-4 text-gray-500">No hay actividad registrada</div>
        </div>
      </section>

      <!-- Achievements Section -->
      <section
        v-if="profileStore.profile.achievements?.length > 0"
