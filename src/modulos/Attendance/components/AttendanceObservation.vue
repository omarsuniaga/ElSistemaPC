<template>
  <div v-if="modelValue || isVisible" class="fixed inset-0 flex items-center justify-center z-50">
    <div class="absolute inset-0 bg-black/50" @click="handleClose" />
    <div
      class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl z-10 max-h-[90vh] overflow-y-auto"
    >
      <!-- Toast notification -->
      <Toast
      ...
      <div class="p-6">
        <div class="flex justify-between items-center mb-6">
          <div class="flex items-center gap-2">
            ...
            <button
              class="text-blue-500 hover:text-blue-700 bg-blue-100 dark:bg-blue-900 dark:text-blue-300 p-1 rounded-full"
              @click="openHelp"
            >
              <svg
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
          <ul class="flex flex-wrap -mb-px">
            <li v-if="canAddObservations" class="mr-2">
              <button
                :class="[
            ...
            <li v-if="canViewObservations" class="mr-2">
              <button
                :class="[
                  'inline-block p-3 rounded-t-lg',
                  activeTab === 'history'
          ...
          <div class="mt-4 mb-3">
            ...
            <div v-if="imageUrls.length > 0" class="mb-3">
              ...
              <div class="flex flex-wrap gap-2">
                ...
                >
                  <img :src="url" alt="Imagen adjunta" class="w-full h-full object-cover" />
                  <div
        ...
        <div v-else-if="activeTab === 'history'">
          <ObservationsHistory
            ...
            :student-id="classObservationMode ? undefined : studentId"
  ...
  <div v-if="showHelp" class="fixed inset-0 flex items-center justify-center z-50">
    <div class="absolute inset-0 bg-black/50" @click="closeHelp" />
    <div
      class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl z-10 p-6 max-h-[80vh] overflow-y-auto"
    >
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold">Guía de funcionalidades del editor</h2>
        <button class="text-gray-500 hover:text-gray-700" @click="closeHelp">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
            fill="none"
      ...
      <div class="space-y-6">
        <div>
          ...
          <ol class="list-decimal pl-5 space-y-1">
            <li>
              Escribe una frase y termínala con un punto <span class="font-mono">(.)</span> o dos
              puntos <span class="font-mono">(:)</span>
            </li>
            <li>
              Presiona <kbd class="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Enter</kbd>
            </li>
          ...
          <div class="mt-2 bg-gray-100 dark:bg-gray-700 p-3 rounded">
            <p class="text-sm italic">
              Ejemplo: "El estudiante debe practicar lo siguiente:"<br />
              Al presionar Enter, se crea: "• "
            </p>
          </div>
        </div>
        ...
        <div>
          <h3 class="text-lg font-medium mb-2 text-blue-600 dark:text-blue-400">
            Etiquetas de estudiantes
          </h3>
          <p class="mb-2">Puedes etiquetar estudiantes en tus observaciones:</p>
          <ol class="list-decimal pl-5 space-y-1">
            <li>
              Escribe el símbolo <span class="font-mono">#</span> en cualquier parte del texto
            </li>
            <li>Se abrirá un selector de estudiantes</li>
            <li>
              Selecciona al estudiante para insertarlo como
              <span class="font-mono">@NombreEstudiante</span>
            </li>
        ...
        <div>
          ...
          <p class="mb-2">
            El sistema aprende de tus observaciones anteriores para ofrecerte sugerencias:
          </p>
          <ol class="list-decimal pl-5 space-y-1">
            <li>Escribe observaciones completas y guárdalas para "entrenar" al sistema</li>
            <li>
              Al escribir nuevas observaciones, cuando el sistema detecte patrones, mostrará
              sugerencias
            </li>
            <li>
              Para aceptar una sugerencia, presiona
              <kbd class="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Tab</kbd>
            </li>
            <li>
              Para ignorar una sugerencia, sigue escribiendo o presiona
              <kbd class="px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Esc</kbd>
            </li>
          </ol>
          <div class="mt-2 bg-gray-100 dark:bg-gray-700 p-3 rounded">
            <p class="text-sm italic">
              El sistema busca coincidencias entre las últimas 3 palabras que escribes y patrones
              guardados anteriormente. Cuantas más observaciones guardes, más inteligente será el
              sistema.
            </p>
          </div>
        </div>
        <div>
          ...
          <ol class="list-decimal pl-5 space-y-1">
            <li>
              ...
              <span
                class="inline-flex items-center dark:text-black gap-1 rounded bg-gray-200 px-2 py-1"
                ><svg
                  class="h-4 w-4"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <li>
              La imagen se subirá automáticamente y aparecerá como miniatura debajo del editor
            </li>
        ...
        <div>
          ...
          <ol class="list-decimal pl-5 space-y-1">
            ...
            <li>
              Para eliminar una imagen, pasa el cursor sobre la miniatura y haz clic en el ícono de
              papelera
            </li>
          ...
          <div class="mt-2 bg-gray-100 dark:bg-gray-700 p-3 rounded">
            <p class="text-sm italic">
              Consejo: Las imágenes subidas son perfectas para documentar partituras,
              posicionamiento de manos, o técnicas específicas que el estudiante debe practicar.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <ol class="list-decimal pl-5 space-y-1">
            <li>
              Haz clic en el botón
              <span
                class="inline-flex items-center px-1 py-1 rounded-full bg-blue-100 text-blue-500"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
                  viewBox="0 0 20 20"
                ...
                >
                  ...
                  /></svg
              ></span>
              junto al título para mostrar esta guía
            </li>
          </ol>
        </div>
      </div>
  ...
  <div v-if="showImageUpload" class="fixed inset-0 flex items-center justify-center z-50">
    <div class="absolute inset-0 bg-black/50" @click="closeImageUpload" />
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-lg z-10 p-6">
      <div class="flex justify-between items-center mb-4">
        ...
        <button class="text-gray-500 hover:text-gray-700" @click="closeImageUpload">
          <XMarkIcon class="h-6 w-6" />
        </button>
      </div>
  ...
  <div
    v-if="showImageGallery && imageUrls.length > 0"
    class="fixed inset-0 flex items-center justify-center z-50"
  >
    <div class="absolute inset-0 bg-black/80" @click="closeImageGallery" />
    <div class="relative z-10 max-w-4xl w-full">
      ...
      <div class="relative bg-white dark:bg-gray-900 p-1 rounded-lg shadow-xl">
        ...
        <div
          ...
          class="absolute inset-x-0 top-1/2 flex justify-between px-4 -translate-y-1/2"
        >
          <button
            class="bg-white/80 dark:bg-gray-800/80 p-2 rounded-full hover:bg-white dark:hover:bg-gray-800"
            @click="prevImage"
        ...
        <div
          v-if="imageUrls.length > 1"
          class="absolute bottom-4 inset-x-0 flex justify-center gap-2"
        >
          <button
