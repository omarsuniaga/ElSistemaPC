...
import {PencilIcon, PlusIcon, TrashIcon, BookmarkIcon} from "@heroicons/vue/24/outline"
...
const selectTemplate = (template: ObservationTemplate) => {
...
<template>
  <div class="class-observation-input">
    ...
    >
      <!-- Barra de categorías -->
      <div
        class="flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50"
      >
        <div class="flex items-center space-x-2">
          <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Categoría:</span>
          <div class="flex space-x-1">
            <button
              ...
              :class="[
                localCategory === category.key
                  ? category.color
                  : 'text-gray-600 bg-white border-gray-300 hover:bg-gray-50',
                props.disabled && 'opacity-50 cursor-not-allowed',
              ]"
              :disabled="props.disabled"
              @click="updateCategory(category.key as any)"
            >
