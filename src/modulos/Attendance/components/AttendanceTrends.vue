    ...
    <div v-else>
      ...
      <div class="card mb-4">
        ...
        <div class="mt-4 flex justify-end">
          <button @click="generateTrends" class="btn btn-primary">
            Generar Tendencias
          </button>
        </div>
      </div>
      ...
      <div v-if="hasTrendData" class="card">
        ...
        <div class="mt-4 text-sm text-gray-600 dark:text-gray-400">
          <p>Este gráfico muestra la evolución de la asistencia a lo largo del tiempo. Las líneas representan los diferentes estados de asistencia.</p>
          <p>Puedes cambiar el rango de fechas y la agrupación para ver diferentes perspectivas de los datos.</p>
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    const filterRecordsByDatePoint = (records, datePoint, groupBy) => {
      return records.filter(record => {
        ...
        if (groupBy === 'day') {
          ...
          return recordDate.getFullYear() === datePoint.getFullYear() &&
    ...
    watch([() => filters.value.startDate, () => filters.value.endDate, () => filters.value.class], 
      () => {
