  ...
  <div class="navigation-management">
    ...
    <div class="bg-white rounded-b-lg shadow-lg">
      ...
      <div v-else-if="error" class="p-6 text-center text-red-600">
        ❌ {{ error }}
        <button @click="loadData" class="ml-2 text-blue-600 underline">Reintentar</button>
      </div>
    ...
    <!-- Changes Indicator -->
    <div v-if="hasChanges" class="fixed bottom-4 right-4 bg-orange-100 border border-orange-400 text-orange-700 px-4 py-2 rounded-lg shadow-lg">
