...
<template>
  <div v-if="instrument" class="bg-white rounded-lg shadow overflow-hidden">
    <div class="bg-indigo-600 p-4 text-white flex flex-col sm:flex-row justify-between items-center gap-2">
    ...
    <div class="p-4">
      ...
      <div class="mb-6" v-if="instrument.accesorios && instrument.accesorios.length > 0">
        ...
        <div class="space-y-2">
          <div v-for="(acc, idx) in instrument.accesorios" :key="idx" class="flex justify-between p-2 border rounded">
            <div>
      ...
      <div class="mb-6" v-if="instrument.historial && instrument.historial.length > 0">
        ...
        <div class="space-y-2">
          <div v-for="(entry, idx) in instrument.historial" :key="idx" class="p-2 border rounded">
            ...
            <div v-if="entry.observaciones" class="text-xs text-gray-600 mt-1">{{ entry.observaciones }}</div>
          </div>
        </div>
      </div>
      <!-- Observaciones -->
