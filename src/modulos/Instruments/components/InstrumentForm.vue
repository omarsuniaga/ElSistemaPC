  ...
  <form class="space-y-4" @submit.prevent="guardar">
    ...
    <div class="border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
      ...
      >
        ...
        <svg
          ...
          :class="accordionOpen.info ? 'rotate-180' : ''"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <div
        v-if="accordionOpen.info"
        class="p-3 border-t border-gray-200 dark:border-gray-600 space-y-3"
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            >
            <input
              v-model="instrumentForm.nombre"
              type="text"
              required
              class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
          ...
          <div>
            ...
            >
            <input
              v-model="instrumentForm.familia"
              type="text"
              class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
          ...
          <div>
            ...
            >
            <input
              v-model="instrumentForm.ubicacion"
              type="text"
              class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
          ...
          <div>
            ...
            >
            <input
              v-model="instrumentForm.fechaIngreso"
              type="date"
              class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
    ...
    <div class="border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
      ...
      >
        ...
        <svg
          class="w-5 h-5 transition-transform text-gray-600 dark:text-gray-400"
          :class="accordionOpen.details ? 'rotate-180' : ''"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    <div class="border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
      ...
      >
        ...
        <svg
          class="w-5 h-5 transition-transform text-gray-600 dark:text-gray-400"
          :class="accordionOpen.status ? 'rotate-180' : ''"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      >
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"
            >Detalles del estado</label
          >
          <textarea
            v-model="instrumentForm.detallesEstado"
            rows="3"
            class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
          />
        </div>
        ...
        <div>
          ...
          >
          <textarea
            v-model="instrumentForm.observaciones"
            rows="3"
            class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
          />
        </div>
    ...
    <div class="border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
      ...
      >
        ...
        <svg
          class="w-5 h-5 transition-transform text-gray-600 dark:text-gray-400"
          :class="accordionOpen.accessories ? 'rotate-180' : ''"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <div
        v-if="accordionOpen.accessories"
        class="p-3 border-t border-gray-200 dark:border-gray-600 space-y-3"
      >
        <!-- Estuche -->
        <div class="border-b border-gray-200 dark:border-gray-600 pb-3">
          ...
          <div class="flex items-center mb-2">
            <input
              v-model="instrumentForm.estuche!.tiene"
              type="checkbox"
              class="mr-2 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded"
            />
          ...
          <div v-if="instrumentForm.estuche?.tiene">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"
              >Estado del estuche</label
            >
            <select
              v-model="instrumentForm.estuche!.estado"
              class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            >
              <option value="excelente">Excelente</option>
              <option value="bueno">Bueno</option>
            ...
            >
            <input
              v-model="instrumentForm.estuche!.observacion"
              type="text"
              class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
        ...
        <div>
          ...
          <div
            v-if="instrumentForm.accesorios && instrumentForm.accesorios.length > 0"
            class="mb-4"
          >
            <div
          ...
          <div class="border border-gray-300 dark:border-gray-600 p-3 rounded-md">
            <h5 class="text-sm font-medium mb-2 text-gray-900 dark:text-white">
              Agregar accesorio
            </h5>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-2 mb-2">
              <input
                v-model="newAccessory.nombre"
                type="text"
                placeholder="Nombre"
                class="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              />

              <select
                v-model="newAccessory.estado"
                class="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              >
                <option value="excelente">Excelente</option>
                <option value="bueno">Bueno</option>
                <option value="regular">Regular</option>
              ...
              <input
                v-model="newAccessory.observacion"
                type="text"
