<template>
  <div class="p-6 max-w-4xl mx-auto">
    <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Galería de Fotos del Instrumento</h1>
    ...
    <div v-else>
      <div v-if="photos.length > 0" class="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div v-for="(photo, idx) in photos" :key="idx" class="bg-white rounded shadow overflow-hidden">
