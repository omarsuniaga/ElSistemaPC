  ...
  <div class="teacher-performance">
    ...
    <div v-else>
        ...
        <div class="flex justify-between items-start">
          <div>
            ...
            <div class="text-sm text-gray-600">
              <p>
                Periodo: {{ format(new Date(report.period.start), "dd/MM/yyyy", {locale: es}) }} -
                {{ format(new Date(report.period.end), "dd/MM/yyyy", {locale: es}) }}
              </p>
            </div>
          </div>
      ...
      <div v-if="report" class="space-y-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <div class="mt-2 flex items-center">
              <span class="text-2xl font-bold"
                >{{ Math.round(report.attendance.attendanceRate) }}%</span
              >
              <div class="ml-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                <div
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <div class="mt-4 grid grid-cols-3 gap-2">
              ...
              <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                ...
                <p class="font-medium">
                  {{ Math.round(report.appUsage.averageSessionDuration) }} min
                </p>
              </div>
              <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
        ...
        <!-- Clases del profesor -->
        <div
          v-if="!props.compact && teacherClassesData.length > 0"
