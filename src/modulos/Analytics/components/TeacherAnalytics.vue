  ...
  <div class="teacher-analytics">
    ...
    <div v-else class="space-y-8">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        ...
        <div class="h-80">
          <Bar :data="weeklyAttendanceBalanceChart" :options="groupedBarChartOptions" />
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          ...
          <div class="h-72">
            <Doughnut :data="specialtyDistributionChart" :options="doughnutOptions" />
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          ...
          <div class="h-72">
            <Bar :data="workloadChart" :options="barChartOptions" />
          </div>
        </div>
      </div>
                  ...
                  <span
                    ...
                    :class="{
                      ...
                      'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200':
                        teacher.attendance >= 90 && teacher.attendance < 95,
        ...
        <div v-if="selectedTeacher" class="space-y-6">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full">
              <thead>
                <tr>
                  <th class="px-2 py-2 text-center bg-gray-50 dark:bg-gray-700" />
                  <th
                    v-for="day in [
                      'Lunes',
                      'Martes',
              ...
              <tbody>
                <tr v-for="(timeSlot, index) in teacherSchedule" :key="index">
                  <td
                    class="px-2 py-2 text-xs font-medium text-gray-500 dark:text-gray-300 bg-gray-50 dark:bg-gray-700"
                  >
                    {{ timeSlot.time }}
                  </td>
                  <td
          ...
          <div class="flex justify-center gap-4">
            <div class="flex items-center">
              <div class="w-3 h-3 bg-green-100 dark:bg-green-800 mr-1" />
              <span class="text-xs">Asistencia alta (>90%)</span>
            </div>
            <div class="flex items-center">
              <div class="w-3 h-3 bg-yellow-100 dark:bg-yellow-800 mr-1" />
              <span class="text-xs">Asistencia media (75-90%)</span>
            </div>
            <div class="flex items-center">
              <div class="w-3 h-3 bg-red-100 dark:bg-red-800 mr-1" />
