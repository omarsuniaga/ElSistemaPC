...
export function getInstrumentBadgeColor(instrument?: string): string {
  ...
  return colors[instrument?.toLowerCase() || ''] || 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200';
}
...
export function getLevelBadgeColor(level?: string): string {
  ...
  return colors[level?.toLowerCase() || ''] || 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200';
}
