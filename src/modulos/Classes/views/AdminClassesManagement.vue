<template>
  <div class="admin-classes-management">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Administra clases, profesores, estudiantes y horarios
        </p>
      </div>
    ...
    <!-- View Toggle Tabs -->
    <div class="mb-6">
      <TabContainer :tabs="viewTabs" :active-tab="currentView" @tab-change="setCurrentView" />
    </div>
    ...
    <!-- Modals -->
    <!-- Class Form Modal -->
    <Modal :show="showClassModal" title="Editar Clase" @close="closeClassModal">
      <ClassFormDialog :class-data="selectedClass" @save="saveClass" @cancel="closeClassModal" />
    </Modal>

    <!-- Schedule View Modal -->
    <Modal :show="showScheduleModal" title="Horario de Clase" @close="closeScheduleModal">
    ...
    <Modal :show="showDeleteModal" title="Confirmar Eliminación" @close="closeDeleteModal">
      <div v-if="selectedClass" class="p-4">
        <div class="text-center mb-4">
          ...
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">¿Eliminar esta clase?</h3>
          <p class="text-gray-600 dark:text-gray-400 mt-2">
            Esta acción no se puede deshacer. La clase "{{ selectedClass.name }}" será eliminada
            permanentemente.
          </p>
        </div>
