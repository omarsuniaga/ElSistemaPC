  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <div class="flex h-screen">
      ...
      >
        <div class="p-2 md:top-0">
          ...
          <div
            class="flex flex-col sm:flex-row justify-between items-start md:items-center mb-6 md:mb-6 gap-4 md:gap-2"
          >
      ...
      >
        <div v-if="selectedClass" class="h-full">
          ...
          <div v-if="isMobile && showMobileDetail" class="h-14" />
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 h-full overflow-y-auto">
              ...
              <div
                v-if="
                  ...
                  (selectedClass.schedule.days?.length ||
              ...
              >
                ...
                <div class="space-y-3">
                  ...
                  <div v-if="selectedClass.schedule.startTime && selectedClass.schedule.endTime">
                    ...
                    <span class="block text-gray-800 dark:text-gray-200"
                      >{{ selectedClass.schedule.startTime }} -
                      {{ selectedClass.schedule.endTime }}</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="mb-6">
                ...
                <div v-if="selectedClass.studentIds && selectedClass.studentIds.length > 0">
                  <ul
                    class="divide-y divide-gray-200 dark:divide-gray-700 bg-gray-50 dark:bg-gray-800 rounded-md"
                  >
                    <li
                  ...
                  <div
                    v-if="selectedClass.studentIds.length > 10"
    ...
    <Modal :show="showInfoModal" title="Información de Clases" @close="showInfoModal = false">
      <div class="text-gray-700 dark:text-gray-300">
        <p>
          Aquí puedes gestionar todas las clases y grupos de tu academia de música. Crea nuevos
          grupos, asigna estudiantes y profesores, y mantén un seguimiento de todas las actividades
          académicas.
        </p>
      </div>
      <template #footer>
