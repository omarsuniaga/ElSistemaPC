<template>
  <div
    class="schedule-stats bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4"
  >
      ...
      <div class="flex items-center space-x-4">
        <div class="flex items-center space-x-2">
          ...
          <span class="text-sm text-gray-600 dark:text-gray-400">
            Clases mostradas:
            <span class="font-semibold text-gray-900 dark:text-white">{{ visibleClasses }}</span>
          </span>
        </div>
        <div class="flex items-center space-x-2">
          ...
          <span class="text-sm text-gray-600 dark:text-gray-400">
            Rango horario:
            <span class="font-semibold text-gray-900 dark:text-white">{{ timeRange }}</span>
          </span>
        </div>
        <div class="flex items-center space-x-2">
          ...
          <span class="text-sm text-gray-600 dark:text-gray-400">
            Modo de vista:
            <span class="font-semibold text-gray-900 dark:text-white">{{ viewModeText }}</span>
          </span>
        </div>
      </div>
