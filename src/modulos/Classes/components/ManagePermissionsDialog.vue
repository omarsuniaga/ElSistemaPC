<template>
  <div v-if="open" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" @click="$emit('close')">
    <div class="bg-white dark:bg-gray-800 rounded-xl max-w-lg w-full" @click.stop>
      ...
      <div class="p-6 space-y-6">
        ...
        </div>        <!-- Custom Permissions (when write or manage is selected) -->
        <div v-if="selectedPermissionLevel !== 'read'" class="border-t border-gray-200 dark:border-gray-700 pt-6">
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div class="space-y-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 p-3 rounded-lg">
              <h5 class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Permisos Básicos</h5>
              <div class="space-y-2">
            ...
            <div v-if="selectedPermissionLevel === 'write' || selectedPermissionLevel === 'manage'" class="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
              <h5 class="text-xs font-medium text-blue-600 dark:text-blue-400 mb-2">Permisos de Edición</h5>
              <div class="space-y-2">
                <label class="flex items-center">
                  <input
                    type="checkbox"
            ...
            <div v-if="selectedPermissionLevel === 'manage'" class="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg">
              <h5 class="text-xs font-medium text-purple-600 dark:text-purple-400 mb-2">Permisos Administrativos</h5>
              <div class="space-y-2">
                <label class="flex items-center">
                  <input
                    type="checkbox"
        ...
        <div v-if="isRemovingAccess" class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
          <div class="flex">
...
const teacherPermissions = computed(() => {
  ...
  const teacher = props.classData.teachers.find(t => 
...
const hasChanges = computed(() => {
  ...
  if (!currentPermissions) {
    ...
    return canAddObservations.value || canEditClass.value || canManageTeachers.value ||
           canTakeAttendance.value || canViewAttendanceHistory.value || 
           canManageStudents.value || canManageSchedule.value;
  }
  
  return canAddObservations.value !== (currentPermissions.canAddObservations || false) ||
