<template>
  <div class="student-conflict-analyzer">
    ...
    <div v-if="isValidating" class="flex items-center justify-center p-6">
      ...
      <span class="ml-3 text-gray-600 dark:text-gray-400">Analizando horarios de estudiantes...</span>
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      <div class="p-4 rounded-lg border" :class="summaryClasses">
        <div class="flex items-start">
          ...
          <div>
            <h4 class="font-medium" :class="summaryTextClasses">{{ formatStudentConflictSummary }}</h4>
      ...
      <div v-if="hasStudentConflicts" class="space-y-3">
        <h4 class="font-medium text-gray-900 dark:text-gray-100">Conflictos Detallados por Estudiante:</h4>
        
        <div v-for="conflicted in conflictedStudents" :key="conflicted.studentId" 
          ...
          <div class="flex items-start">
            ...
            <div class="flex-1">
              ...
              <ul class="space-y-1">
                <li v-for="(conflict, index) in conflicted.conflicts" :key="index" 
      ...
      <!-- Success State -->
      <div v-else-if="studentIds && studentIds.length > 0" 
