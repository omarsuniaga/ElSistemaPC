...
<template>
  <div class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-3 sticky bottom-0">
    ...
    <form @submit.prevent="sendActivity" class="flex items-center gap-2">
      <textarea
        v-model="message"
