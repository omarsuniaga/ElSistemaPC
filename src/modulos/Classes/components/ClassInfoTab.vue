...
<template>
  <div class="space-y-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
      <div class="flex justify-between items-center mb-4">
        ...
        <div v-else class="flex gap-2">
          ...
          >
            ...
            <span
              v-if="saveLoading"
              class="h-4 w-4 mr-1 animate-spin rounded-full border-t-2 border-green-500"
            />
      ...
      <div
        v-if="saveError"
        class="mb-4 p-2 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 text-sm rounded-md"
      >
        {{ saveError }}
      </div>
      ...
      <div
        v-if="saveSuccess"
        class="mb-4 p-2 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 text-sm rounded-md"
      >
      ...
      <div v-if="!isEditing" class="space-y-3">
        ...
        <div class="flex items-start">
          ...
          <div class="flex-1 text-gray-900 dark:text-white">
            {{ selectedClass.instrument || "No especificado" }}
          </div>
        </div>
        ...
        <div class="flex items-start">
          ...
          <div class="flex-1 text-gray-900 dark:text-white">
            {{ selectedClass.classroom || "No asignada" }}
          </div>
        </div>
