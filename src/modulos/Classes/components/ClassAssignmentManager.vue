<template>
  <div class="class-assignment-manager">
    <!-- Header -->
    <div class="mb-6">
      <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Gestión de Asignaciones</h2>
      ...
      >
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <div
                class="h-12 w-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center mr-4"
              >
            ...
            <div class="flex items-center space-x-2">
              ...
              <div class="flex items-center space-x-1">
                ...
                <div
                  ...
                  :title="
                    classItem.studentIds?.length ? 'Estudiantes asignados' : 'Sin estudiantes'
                  "
                />
                <div
                  :class="[
        ...
        <div v-if="expandedClasses.includes(classItem.id)" class="p-6 space-y-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-3">
              ...
              <div
                class="max-h-32 overflow-y-auto space-y-1 border border-gray-200 dark:border-gray-600 rounded-lg p-2"
              >
                <label
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-2">
                <select
                  ...
                  @change="
                    updateScheduleDay(classItem.id, ($event.target as HTMLSelectElement).value)
                  "
                >
                ...
                <div class="grid grid-cols-2 gap-2">
                  ...
                  <input
                    ...
                    class="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"
                    @change="
                      updateScheduleEndTime(classItem.id, ($event.target as HTMLInputElement).value)
                    "
                  />
                </div>
              </div>
