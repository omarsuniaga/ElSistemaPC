  ...
  <div class="class-schedule-view">
    ...
    <div v-if="viewMode === 'week'" class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div class="overflow-y-auto max-h-96">
        ...
        >
          <!-- Time label -->
          <div class="p-3 border-r border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50">
    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div class="p-4">
          <div v-if="getClassesForDay(day.value).length === 0" class="text-center py-8 text-gray-500 dark:text-gray-400">
              ...
              <div class="flex items-center space-x-4">
                <div class="flex-shrink-0">
                  <div :class="[
                    ...
                    getInstrumentColor(classItem.instrument)
                  ]"></div>
                </div>
    ...
    <div v-if="filteredClasses.length === 0" class="text-center py-12">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No hay clases programadas</h3>
...
function getClassColor(instrument?: string): string {
  if (!instrument) return 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-600';
  
  const colors: Record<string, string> = {
    piano: 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 border-blue-200 dark:border-blue-700',
    guitarra: 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 border-green-200 dark:border-green-700',
    violin: 'bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 border-purple-200 dark:border-purple-700',
    flauta: 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 border-yellow-200 dark:border-yellow-700',
    bateria: 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 border-red-200 dark:border-red-700',
    canto: 'bg-pink-100 dark:bg-pink-900 text-pink-800 dark:text-pink-200 border-pink-200 dark:border-pink-700'
  };
  return colors[instrument] || 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-600';
}
