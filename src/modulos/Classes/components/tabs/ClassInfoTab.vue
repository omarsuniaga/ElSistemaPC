<template>
  <div class="class-info-tab p-4">
    ...
    <div v-if="classData" class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium">Nombre:</p>
        <p class="text-gray-800 dark:text-gray-200">{{ classData.name }}</p>
      </div>
      <div>
        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium">Instrumento:</p>
        <p class="text-gray-800 dark:text-gray-200">{{ classData.instrument }}</p>
      </div>
      <div>
        <p class="text-sm text-gray-600 dark:text-gray-400 font-medium">Nivel:</p>
        <p class="text-gray-800 dark:text-gray-200">{{ classData.level }}</p>
      </div>
      <div>
    ...
    <div v-else>
      <p class="text-gray-500 dark:text-gray-400">No hay información disponible para esta clase.</p>
    </div>
