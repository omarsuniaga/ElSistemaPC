<template>
  <div class="class-list">
    ...
    <div class="mb-6">
      ...
      <div v-if="search && filteredClasses.length > 0" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
    ...
    <div v-else class="hidden lg:block">
      <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 transition-colors duration-200">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0">
                    <div class="h-12 w-12 rounded-lg flex items-center justify-center transition-colors duration-200"
                  ...
                  <div class="ml-4">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400 flex items-center space-x-2">
                      ...
                      <span v-if="item.sharedWith && item.sharedWith.length > 0" class="text-purple-500 dark:text-purple-400 text-xs">
                        (Compartida)
                      </span>
                    </div>
                  </div>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="ml-3">
                    ...
                    <div v-if="item.sharedWith && item.sharedWith.length > 0" class="text-xs text-purple-600 dark:text-purple-400">
                      +{{ item.sharedWith.length }} colaborador{{ item.sharedWith.length !== 1 ? 'es' : '' }}
                    </div>
                  </div>
                </div>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end space-x-2">
                  ...
                  <div class="relative group/tooltip">
                    ...
                    <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 text-xs text-white bg-gray-900 dark:bg-gray-700 rounded opacity-0 group-hover/tooltip:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10">
                      Editar clase
                    </div>
                  </div>
      ...
      >
        ...
        <div class="flex items-start justify-between mb-4">
          ...
          <div class="flex-shrink-0 ml-2">
            <span :class="getStatusBadgeClass(item.status)" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium">
              {{ getStatusText(item.status) }}
            </span>
          </div>
        </div>
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center">
            ...
            <div class="flex-1">
              ...
              <span class="ml-1 text-sm font-medium text-gray-900 dark:text-white">{{ getTeacherName(item.teacherId) }}</span>
              <div v-if="item.sharedWith && item.sharedWith.length > 0" class="text-xs text-purple-600 dark:text-purple-400 mt-1">
          ...
          <div class="flex items-center">
            ...
            <div class="flex-1">
              ...
              <span class="ml-1 text-sm font-medium text-gray-900 dark:text-white">
                {{ item.studentIds?.length || 0 }} inscrito{{ (item.studentIds?.length || 0) !== 1 ? 's' : '' }}
              </span>
            </div>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="flex-1">
              ...
              <span class="ml-1 text-sm font-medium text-gray-900 dark:text-white">{{ formatSchedule(item.schedule) }}</span>
            </div>
          </div>
        </div>
