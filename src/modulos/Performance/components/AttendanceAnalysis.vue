    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <div class="space-y-1">
            <p class="text-xl font-bold text-gray-900 dark:text-white">{{ data?.attendanceRate || 0 }}%</p>
        ...
        <div class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <div class="space-y-1">
            <p class="text-xl font-bold text-gray-900 dark:text-white">{{ data?.punctualityRate || 0 }}%</p>
      ...
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
        <h5 class="text-base font-semibold text-gray-900 dark:text-white mb-4">Patrón de Asistencia (Últimos 3 meses)</h5>
        <div class="space-y-4">
          ...
          <div class="space-y-4">
            ...
            <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
              <span v-for="week in mockWeeklyData" :key="week.week">
                S{{ week.week }}
              </span>
            </div>
          </div>
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-3 p-3 rounded-lg bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300">
            <CheckCircleIcon class="w-5 h-5" />
            <p>Ha mejorado su asistencia en las últimas 4 semanas</p>
          </div>
          
          <div class="flex items-center gap-3 p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300">
            <InformationCircleIcon class="w-5 h-5" />
            <p>Patrón más irregular los días lunes</p>
          </div>
          
          <div class="flex items-center gap-3 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div class="space-y-1">
              <h6 class="font-semibold text-gray-900 dark:text-white">Establecer rutina de recordatorios</h6>
              <p class="text-sm text-gray-600 dark:text-gray-400">Configurar notificaciones 30 minutos antes de cada clase</p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div class="space-y-1">
              <h6 class="font-semibold text-gray-900 dark:text-white">Agendar clases de recuperación</h6>
              <p class="text-sm text-gray-600 dark:text-gray-400">Programar sesiones adicionales para compensar clases perdidas</p>
            </div>
          </div>
        </div>
      </div>
