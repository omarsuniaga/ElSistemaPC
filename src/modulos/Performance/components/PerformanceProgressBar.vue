  ...
  >
    ...
    <div class="progress-container space-y-3">
      ...
      <div class="progress-bar-container flex items-center space-x-3">
        ...
        <div class="progress-percentage text-sm font-medium text-gray-700 min-w-[3rem] text-right">{{ Math.round(score) }}%</div>
      </div>
    </div>
    ...
    <div v-if="showDetails" class="metrics-details border-t border-gray-100 pt-4">
      <div class="metrics-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <div class="metric-item space-y-2">
          <div class="metric-label text-xs font-medium text-gray-600 uppercase tracking-wide">Asistencia</div>
        ...
        <div class="metric-item space-y-2">
          <div class="metric-label text-xs font-medium text-gray-600 uppercase tracking-wide">Repertorio</div>
          <div class="metric-value flex items-center space-x-2">
            <div class="mini-progress w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
              <div 
                class="mini-fill h-full transition-all duration-300"
            ...
            <span class="metric-text text-sm font-medium text-gray-900">{{ repertoireScore }}/100</span>
          </div>
        </div>
        
        <div class="metric-item space-y-2">
          <div class="metric-label text-xs font-medium text-gray-600 uppercase tracking-wide">Trabajo Individual</div>
          <div class="metric-value flex items-center space-x-2">
            <div class="mini-progress w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
              <div 
                class="mini-fill h-full transition-all duration-300"
            ...
            <span class="metric-text text-sm font-medium text-gray-900">{{ individualWorkScore }}/100</span>
          </div>
        </div>
        
        <div class="metric-item space-y-2">
          <div class="metric-label text-xs font-medium text-gray-600 uppercase tracking-wide">Trabajo Colectivo</div>
          <div class="metric-value flex items-center space-x-2">
            <div class="mini-progress w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
              <div 
                class="mini-fill h-full transition-all duration-300"
            ...
            <span class="metric-text text-sm font-medium text-gray-900">{{ collectiveWorkScore }}/100</span>
          </div>
        </div>
        
        <div class="metric-item space-y-2">
          <div class="metric-label text-xs font-medium text-gray-600 uppercase tracking-wide">Observaciones Positivas</div>
          <div class="metric-value flex items-center space-x-2">
            <div class="observations-count flex items-center space-x-2">
              <ChatBubbleLeftEllipsisIcon class="h-5 w-5 text-blue-500" />
              <span class="metric-text text-sm font-medium text-gray-900">{{ positiveObservations }}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Tendencia -->
    <div v-if="showTrend && trend !== undefined" class="trend-indicator border-t border-gray-100 pt-3">
    ...
    <div v-if="showRecommendations && recommendations.length > 0" class="recommendations border-t border-gray-100 pt-3 space-y-2">
      <div class="recommendations-header flex items-center space-x-2 text-sm font-medium text-gray-700">
