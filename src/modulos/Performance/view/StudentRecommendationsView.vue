  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div class="space-y-4">
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Recomendaciones Personalizadas</h1>
          <div v-if="student" class="flex items-center">
            ...
            />
            <div>
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ student.nombre }} {{ student.apellido }}</h2>
              <p class="text-sm text-gray-600 dark:text-gray-400">{{ student.instrumento }} • {{ student.clase }}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="space-y-6">
          ...
          >
            <div class="flex items-center gap-4 p-6 bg-gray-50 dark:bg-gray-700">
              <div class="flex-shrink-0 w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center text-blue-600 dark:text-blue-400">
              ...
              <div class="flex-shrink-0">
                <span 
                  :class="[
                    ...
                    category.priority === 'high' ? 'bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300' :
                    category.priority === 'medium' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300' : 
            ...
            <div class="p-6 space-y-4">
              ...
              >
                <div class="space-y-3 mb-4">
                  <h4 class="font-semibold text-gray-900 dark:text-white">{{ recommendation.title }}</h4>
                  ...
                  <div v-if="recommendation.timeline" class="flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400">
          ...
          <div class="space-y-6">
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ item.progress }}%</span>
              </div>
              ...
              <div class="space-y-1">
                ...
                <p class="text-sm font-medium text-blue-600 dark:text-blue-400">Próximo paso: {{ item.nextStep }}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <div class="flex-shrink-0 text-right">
                ...
                <span class="block text-sm font-medium text-gray-900 dark:text-white">{{ formatDate(goal.deadline) }}</span>
              </div>
            </div>
          </div>
        </div>
    ...
    recommendations: [
      {
        ...
        description: 'Se recomienda crear un horario fijo para las clases de música y establecer recordatorios.',
        metrics: [
        ...
        actions: [
          ...
          { id: 'reminders', label: 'Configurar Recordatorios', type: 'secondary', icon: EnvelopeIcon }
        ]
      }
    ]
  },
