<template>
  <div class="emergency-classes-section space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Clases Emergentes</h2>
    ...
    <!-- Empty State -->
    <div
      v-else-if="filteredEmergencyClasses.length === 0"
    ...
    >
      ...
      <p class="text-gray-600 dark:text-gray-400 mb-4">
        {{
          hasFilters
            ? "No se encontraron clases emergentes con los filtros aplicados"
            : "Aún no has creado ninguna clase emergente"
        }}
      </p>
      <button
        v-if="hasFilters"
        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            ...
            <div class="mb-4">
              ...
              <div v-if="expandedClasses.has(emergencyClass.id)" class="space-y-1">
                ...
                >
                  ...
                  <span
                    v-if="getAttendanceStatus(emergencyClass.id, studentId)"
                    class="text-xs px-2 py-1 rounded"
                    :class="
                      getAttendanceStatusClass(getAttendanceStatus(emergencyClass.id, studentId))
                    "
                  >
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-4">
              ...
              <span
                v-if="
                  emergencyClass.updatedAt && emergencyClass.updatedAt !== emergencyClass.createdAt
                "
              >
