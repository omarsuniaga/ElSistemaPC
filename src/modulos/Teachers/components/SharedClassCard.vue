  ...
  >
    ...
    <div class="absolute top-3 right-3 z-10">
      <div class="flex items-center space-x-2">
        <!-- Badge de "Compartida" -->
        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 border border-purple-200 dark:border-purple-700">
    ...
    <div :class="[getDayColor.bg, 'p-4 border-b border-gray-200 dark:border-gray-700']">
      <div class="flex items-start justify-between">
        ...
        <Menu as="div" class="relative">
          <MenuButton class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
            <EllipsisVerticalIcon class="w-5 h-5" />
          </MenuButton>
          <MenuItems class="absolute right-0 z-20 mt-2 w-56 origin-top-right bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
            <div class="p-1">
              <MenuItem v-slot="{ active }">
                <button
                  @click="viewClass"
                  :class="[active ? 'bg-gray-100 dark:bg-gray-700' : '', 'flex items-center w-full px-3 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-md']"
                >
