            ...
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Selecciona un maestro para invitar a gestionar esta clase. El maestro invitado podrá tomar asistencia y añadir observaciones según los permisos que asignes.
                </p>
              </div>

              <!-- Selector de maestro -->
              <div class="mt-4">
                <label for="teacher-select" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                  Seleccionar Maestro
                </label>
                <select
                  id="teacher-select"
              ...
              <!-- Error message -->
              <div v-if="error" class="mt-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-md">
