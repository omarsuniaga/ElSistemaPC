...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <div v-if="sortedClasses.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div 
        ...
        >
          ...
          <div class="p-4">
            ...
            <div class="flex items-center mb-3 text-sm">
              ...
              <MusicalNoteIcon v-if="classItem.instrument" class="h-4 w-4 mr-2 text-gray-500 dark:text-gray-400" />
              ...
              <div>
                <div v-if="classItem.studentIds && classItem.studentIds.length > 0">
                  ...
                  <ul class="mt-1 space-y-1">
                    <li v-for="student in getClassStudents(classItem).slice(0, 3)" :key="student.id" class="truncate">
                      {{ student.name }}
                    </li>
                    <li v-if="classItem.studentIds.length > 3" class="text-gray-500 dark:text-gray-400 italic">
    ...
    <Dialog :open="showClassForm" @close="showClassForm = false" class="relative z-50">
    ...
    <Dialog :open="showStudentManager" @close="showStudentManager = false" class="relative z-50">
      <div class="fixed inset-0 flex items-center justify-center p-4">
        <DialogOverlay class="fixed inset-0 bg-black bg-opacity-50 transition-opacity" />
        ...
        <div class="fixed inset-0 overflow-y-auto">
          <div class="flex min-h-full items-center justify-center p-4">
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
              ...
              <p class="mb-4">
                ¿Estás seguro de que deseas eliminar la clase <strong>{{ classToDelete?.name }}</strong>? Esta acción no se puede deshacer.
              </p>
