<template>
  ...
  <div
    class="bg-gradient-to-br from-white via-gray-50/50 to-white dark:from-gray-800 dark:via-gray-800/50 dark:to-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm"
  >
    ...
    <div class="p-6 pb-4 border-b border-gray-200/50 dark:border-gray-700/50">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2
            class="text-2xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent"
          >
            Mis Clases
          </h2>
        ...
        <div class="flex items-center gap-3">
          ...
          <div
            class="flex bg-gray-100 dark:bg-gray-700/50 rounded-xl p-1 shadow-inner border border-gray-200/30 dark:border-gray-600/30"
          >
            <button
              :class="[
      ...
      <div class="mt-4 flex items-center gap-6 text-sm">
        <div class="flex items-center gap-2">
          ...
          <span class="text-gray-600 dark:text-gray-400">
            {{ classes.length }} clase{{ classes.length !== 1 ? "s" : "" }} activa{{
              classes.length !== 1 ? "s" : ""
            }}
          </span>
        </div>
      ...
      >
        ...
        <div v-else class="col-span-full py-16 text-center">
          <div class="max-w-md mx-auto">
            <div
              class="w-20 h-20 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full flex items-center justify-center mx-auto mb-6"
            >
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6">
              No tienes clases asignadas actualmente. Crea tu primera clase para comenzar a enseñar
              música.
            </p>
            <button
