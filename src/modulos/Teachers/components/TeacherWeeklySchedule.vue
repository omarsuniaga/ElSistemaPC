        ...
        <div>
          ...
          <div v-if="getClassesForDay(day).length > 0" class="day-section">
            <div class="mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">
              <h3 class="text-xl md:text-2xl font-semibold text-gray-800 dark:text-white">
                {{ day }}
              </h3>
            </div>
              ...
              >
                <div class="p-4 flex-grow">
                  ...
                  <div class="class-details space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div
                      v-if="
                        getScheduleForDay(class_, day)?.startTime &&
                        getScheduleForDay(class_, day)?.endTime
                      "
                ...
                <div
                  class="border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-2"
                >
                  <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                    <UserGroupIcon class="h-5 w-5 mr-2 flex-shrink-0" />
                    <span
                      >{{ class_.studentIds?.length || 0 }}
                      {{ class_.studentIds?.length === 1 ? "estudiante" : "estudiantes" }}</span
                    >
                  </div>
                </div>
              </div>
          ...
          <div
            v-else
            class="empty-day text-center py-6 px-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-dashed border-gray-300 dark:border-gray-700"
          >
...
.day-section:nth-child(1) h3 {
  color: #ef4444; /* Lunes - Rojo */
}
.day-section:nth-child(2) h3 {
  color: #f97316; /* Martes - Naranja */
}
.day-section:nth-child(3) h3 {
  color: #eab308; /* Miércoles - Amarillo */
}
.day-section:nth-child(4) h3 {
  color: #22c55e; /* Jueves - Verde */
}
.day-section:nth-child(5) h3 {
  color: #3b82f6; /* Viernes - Azul */
}
.day-section:nth-child(6) h3 {
  color: #8b5cf6; /* Sábado - Púrpura */
}
.day-section:nth-child(7) h3 {
  color: #ec4899; /* Domingo - Rosa */
}

/* Modo oscuro */
.dark .day-section:nth-child(1) h3 {
  color: #fca5a5; /* Lunes - Rojo claro */
}
.dark .day-section:nth-child(2) h3 {
  color: #fdba74; /* Martes - Naranja claro */
}
.dark .day-section:nth-child(3) h3 {
  color: #fde047; /* Miércoles - Amarillo claro */
}
.dark .day-section:nth-child(4) h3 {
  color: #86efac; /* Jueves - Verde claro */
}
.dark .day-section:nth-child(5) h3 {
  color: #93c5fd; /* Viernes - Azul claro */
}
.dark .day-section:nth-child(6) h3 {
  color: #c4b5fd; /* Sábado - Púrpura claro */
}
.dark .day-section:nth-child(7) h3 {
  color: #f9a8d4; /* Domingo - Rosa claro */
}
</style>
