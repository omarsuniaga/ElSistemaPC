    ...
    >
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="bg-white dark:bg-gray-700/50 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-600">
        ...
        <!-- Schedule Section -->
        <div class="bg-white dark:bg-gray-700/50 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 overflow-hidden">
          <div class="px-4 py-3 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
            <h3 class="font-semibold text-gray-900 dark:text-white">Horario de Clases</h3>
          </div>

          <div v-if="schedule?.schedule?.length" class="divide-y divide-gray-200 dark:divide-gray-600">
            <div
            ...
            >
              <div class="flex justify-between items-start">
                <div class="flex-1">
                  <div class="font-medium text-gray-900 dark:text-white flex items-center gap-2">
                    {{ day.className }}
                    <span class="px-2 py-0.5 text-xs bg-primary-100 dark:bg-primary-900/30 text-primary-800 dark:text-primary-200 rounded-full">
              ...
              <div v-if="day.students?.length" class="mt-2 pl-4 border-l-2 border-gray-200 dark:border-gray-600">
          ...
          <div class="p-4">
            <div class="space-y-2">
              <div class="flex justify-between items-center text-sm">
                ...
                <span class="font-medium text-gray-900 dark:text-white">{{ formatHours(schedule?.weeklyHours || 0) }}</span>
              </div>
              <div class="flex justify-between items-center text-sm">
                <span class="text-gray-600 dark:text-gray-400">Clases por Semana:</span>
                <span class="font-medium text-gray-900 dark:text-white">{{ schedule?.totalClasses || 0 }}</span>
              </div>
              <div class="flex justify-between items-center text-sm">
                <span class="text-gray-600 dark:text-gray-400">Promedio Estudiantes/Clase:</span>
                <span class="font-medium text-gray-900 dark:text-white">
                  {{ schedule?.schedule?.length ? Math.round(getTotalStudents() / schedule.schedule.length) : 0 }}
                </span>
              </div>
            </div>
          </div>
