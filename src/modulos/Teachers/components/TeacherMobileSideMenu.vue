  ...
  <div>
    ...
    >
      <div class="flex justify-between items-center mb-6">
        ...
        <button @click="emit('close-menu')" class="p-1 rounded-md text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <button
          ...
          :class="activeTab === item.id ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' : 'hover:bg-gray-100 dark:hover:bg-gray-800'"
        >
