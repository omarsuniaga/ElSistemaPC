    ...
    <div v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          ...
          <p v-if="safeGet(claseMasAlumnos, 'nombre')">
            {{ safeGet(claseMasAlumnos, "cantidad", 0) }} alumnos
          </p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          ...
          <p v-if="safeGet(claseMenosAlumnos, 'nombre')">
            {{ safeGet(claseMenosAlumnos, "cantidad", 0) }} alumnos
          </p>
        </div>
      </div>
      ...
      <div class="mb-6">
        ...
        <div class="mt-4">
          <div
            v-if="safeArrayLength(safeGet(clasesPorDia, selectedDay, [])) > 0"
          ...
          >
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              >
                <tr
                  v-for="clase in safeGet(clasesPorDia, selectedDay, [])"
                  :key="safeGet(clase, 'id', Math.random())"
                >
