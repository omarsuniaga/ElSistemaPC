        ...
        if (Math.random() < 0.75) {
            ...
            if (rand < 0.78) {
              ...
              if (Math.random() < 0.35) {
                justificacion.push({
                  ...
                  classId,
                  fecha,
                  reason: ['Cita médica', 'Enfermedad', 'Emergencia', 'Viaje'][
          ...
          const data = {
            ...
            data: {
              ...
              justificacion,
              observación:
                Math.random() < 0.3 ? `Clase del ${fecha} desarrollada correctamente` : '',
              observations: [],
            },
          };
          ...
          try {
            ...
            if (window.firebase?.firestore) {
              ...
              console.log(
                `   ${presentes.length} presentes, ${ausentes.length} ausentes, ${tarde.length} tarde, ${justificacion.length} justificados`,
              );
            }
