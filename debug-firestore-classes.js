...
window.debugFirestoreClasses = () => {
  ...
  classes.forEach((cls, index) => {
    ...
    if (cls.teachers) {
      console.log(`   teachers: [${Array.isArray(cls.teachers) ? cls.teachers.join(', ') : cls.teachers}]`);
      console.log(`   Es compartida: ${Array.isArray(cls.teachers) && cls.teachers.length > 0 ? '✅ SÍ' : '❌ NO'}`);
    } else {
