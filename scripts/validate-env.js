...
if (missingVars.length > 0) {
  console.error(
    '\x1b[31mError: Las siguientes variables de entorno son requeridas o tienen valores incorrectos:\x1b[0m',
  );
  missingVars.forEach((varName) => {
    console.error(`- ${varName}`);
  });
  console.error(
    '\x1b[33mAsegúrate de que tu archivo ${envFile} tenga estas variables correctamente configuradas.\x1b[0m',
  );
  process.exit(1);
}
...
// Todo bien
console.log(
  '\x1b[32mValidación exitosa: Todas las variables de entorno de Firebase están correctamente configuradas.\x1b[0m',
);
process.exit(0);
