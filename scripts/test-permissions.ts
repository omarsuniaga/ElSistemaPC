...
import { UserRole, ResourceType, PermissionAction, ROLE_PERMISSIONS } from '../src/modulos/Auth/types/permissions'
...
function checkPermissionStatic(role: UserRole, resource: ResourceType, action: PermissionAction): boolean {
