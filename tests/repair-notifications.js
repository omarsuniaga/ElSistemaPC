...
window.repairNotifications = async function () {
  ...
  try {
    ...
    if (typeof firebase === "undefined" && typeof window.firebase === "undefined") {
      console.error(
        "❌ Firebase no está disponible. Ejecuta este script en la consola del navegador."
      )
      return
    }
...
console.log("")
console.log(
  "💡 Para usar: Abre la consola del navegador en la página del dashboard y ejecuta las funciones."
)
