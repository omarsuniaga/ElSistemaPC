...
class FirebaseObservationAnalyzer {
  ...
  async analyzeAsistencias() {
    ...
    try {
      ...
      console.log(`✅ ASISTENCIAS: ${this.stats.asistencias.total} docs, ${this.stats.asistencias.withObs} con observaciones, ${this.stats.asistencias.totalObs} observaciones totales`);
  ...
  async checkUnified() {
    ...
    try {
      ...
      if (snapshot.size > 0) {
        console.log(`✅ OBSERVACIONES_UNIFICADAS: ${this.stats.unificadas.total} documentos ya migrados`);
